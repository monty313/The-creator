# Tweak record: `sauce__dimension_jump`

**Title:** Dimension Jump sauce  
**Kind:** sauce  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\sauces\DimensionJump_sauce.md`  
**Adapter profile:** `dimension_jump`  
...
Profile `dimension_jump` keeps this family's original signal language; accuracy layer is the shared Mark filter + TP/SL tier `A_first_breath`.
...
| Metric | Value |
|--------|------:|
| Win rate (accuracy) % | 71.7906 |
| Total trades (sum set×mode) | 594 |
| Total return % (avg set×mode) | -0.4365 |
| Max drawdown % (avg) | 0.8945 |
| Profit factor (avg) | 13.1385 |
| Sharpe (avg) | -2.0177 |
| Aggregate score | 1313.1901 |
| Runs (set×mode) | 8 |

**Delta win rate:** +28.6352 pp vs baseline.

# Tweak record: `mt__JordanMomentumScreener_v10`

**Title:** JordanMomentumScreener_v10  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: JordanMomentumScreener_v10 (.mq5)`  
...
**Family id:** `mt__JordanMomentumScreener_v10`  
**MC rank (by bootstrap median terminal):** **70** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.963167× |
| Mean terminal wealth | 0.963499× |
| p05 terminal | 0.935272× |
| p25 terminal | 0.950584× |
| p75 terminal | 0.976016× |
| p95 terminal | 0.993344× |
| P(loss) = P(terminal < 1) | 97.10% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 4.3421% |
| p95 path max DD | 6.8938% |

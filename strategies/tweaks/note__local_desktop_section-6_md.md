# Tweak record: `note__local_desktop_section-6_md`

**Title:** section-6.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\local_desktop\section-6.md`  
...
**Family id:** `note__local_desktop_section-6_md`  
**MC rank (by bootstrap median terminal):** **112** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.940169× |
| Mean terminal wealth | 0.940465× |
| p05 terminal | 0.903906× |
| p25 terminal | 0.923380× |
| p75 terminal | 0.956369× |
| p95 terminal | 0.979097× |
| P(loss) = P(terminal < 1) | 99.50% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.7064% |
| p95 path max DD | 10.1710% |

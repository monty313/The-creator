# Tweak record: `note__army_library_strategy_copy_section-1_md`

**Title:** section-1.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\army_library_strategy_copy\section-1.md`  
...
**Family id:** `note__army_library_strategy_copy_section-1_md`  
**MC rank (by bootstrap median terminal):** **119** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.939733× |
| Mean terminal wealth | 0.939909× |
| p05 terminal | 0.899415× |
| p25 terminal | 0.923827× |
| p75 terminal | 0.955432× |
| p95 terminal | 0.979237× |
| P(loss) = P(terminal < 1) | 99.40% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.7591% |
| p95 path max DD | 10.4688% |

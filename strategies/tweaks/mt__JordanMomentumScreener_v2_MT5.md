# Tweak record: `mt__JordanMomentumScreener_v2_MT5`

**Title:** JordanMomentumScreener_v2_MT5  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: JordanMomentumScreener_v2_MT5 (.mq5)`  
...
**Family id:** `mt__JordanMomentumScreener_v2_MT5`  
**MC rank (by bootstrap median terminal):** **65** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.963903× |
| Mean terminal wealth | 0.963821× |
| p05 terminal | 0.935816× |
| p25 terminal | 0.952392× |
| p75 terminal | 0.975994× |
| p95 terminal | 0.990771× |
| P(loss) = P(terminal < 1) | 98.40% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 4.2830% |
| p95 path max DD | 6.8742% |

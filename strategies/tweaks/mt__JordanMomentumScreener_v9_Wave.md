# Tweak record: `mt__JordanMomentumScreener_v9_Wave`

**Title:** JordanMomentumScreener_v9_Wave  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: JordanMomentumScreener_v9_Wave (.mq5)`  
...
**MC rank (by bootstrap median terminal):** **63** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.964217× |
| Mean terminal wealth | 0.964897× |
| p05 terminal | 0.935658× |
| p25 terminal | 0.953888× |
| p75 terminal | 0.976505× |
| p95 terminal | 0.993708× |
| P(loss) = P(terminal < 1) | 97.70% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 4.2255% |
| p95 path max DD | 6.8372% |

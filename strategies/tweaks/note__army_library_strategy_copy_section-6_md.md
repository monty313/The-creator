# Tweak record: `note__army_library_strategy_copy_section-6_md`

**Title:** section-6.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\army_library_strategy_copy\section-6.md`  
...
**MC rank (by bootstrap median terminal):** **121** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.939662× |
| Mean terminal wealth | 0.939567× |
| p05 terminal | 0.902935× |
| p25 terminal | 0.925398× |
| p75 terminal | 0.953608× |
| p95 terminal | 0.977502× |
| P(loss) = P(terminal < 1) | 99.70% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.7492% |
| p95 path max DD | 10.2845% |

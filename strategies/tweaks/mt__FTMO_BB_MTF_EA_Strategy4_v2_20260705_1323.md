# Tweak record: `mt__FTMO_BB_MTF_EA_Strategy4_v2_20260705_1323`

**Title:** FTMO_BB_MTF_EA_Strategy4_v2_20260705_1323  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: FTMO_BB_MTF_EA_Strategy4_v2_20260705_1323 (.mq5)`  
...
**MC rank (by bootstrap median terminal):** **17** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 1.003846× |
| Mean terminal wealth | 1.003588× |
| p05 terminal | 0.987117× |
| p25 terminal | 0.996861× |
| p75 terminal | 1.010406× |
| p95 terminal | 1.018753× |
| P(loss) = P(terminal < 1) | 34.10% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 0.9430% |
| p95 path max DD | 1.9066% |

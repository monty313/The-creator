# Tweak record: `mt__AutoTradingBot_RF`

**Title:** AutoTradingBot_RF  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: AutoTradingBot_RF (.mq5)`  
...
**MC rank (by bootstrap median terminal):** **123** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.939635× |
| Mean terminal wealth | 0.939812× |
| p05 terminal | 0.901469× |
| p25 terminal | 0.923952× |
| p75 terminal | 0.955011× |
| p95 terminal | 0.981638× |
| P(loss) = P(terminal < 1) | 98.90% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.7438% |
| p95 path max DD | 10.3372% |

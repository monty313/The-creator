# Tweak record: `note__army_library_strategy_copy_new_trading_strategies_md`
...
**Family id:** `note__army_library_strategy_copy_new_trading_strategies_md`  
**MC rank (by bootstrap median terminal):** **88** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.941306× |
| Mean terminal wealth | 0.940453× |
| p05 terminal | 0.902408× |
| p25 terminal | 0.924972× |
| p75 terminal | 0.956562× |
| p95 terminal | 0.977104× |
| P(loss) = P(terminal < 1) | 99.40% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.6460% |
| p95 path max DD | 10.2224% |

# Tweak record: `note__army_library_strategy_copy_section-2_md`

**Title:** section-2.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\army_library_strategy_copy\section-2.md`  
...
**Family id:** `note__army_library_strategy_copy_section-2_md`  
**MC rank (by bootstrap median terminal):** **91** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.941156× |
| Mean terminal wealth | 0.941601× |
| p05 terminal | 0.904601× |
| p25 terminal | 0.924899× |
| p75 terminal | 0.958282× |
| p95 terminal | 0.978094× |
| P(loss) = P(terminal < 1) | 99.20% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.6222% |
| p95 path max DD | 10.0565% |

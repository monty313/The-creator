# Tweak record: `mt__cci_gravity_scalp_ftmo` (CCI upgraded)
...
**MC rank (by bootstrap median terminal):** **13** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 1.008251× |
| Mean terminal wealth | 1.008145× |
| p05 terminal | 1.005184× |
| p25 terminal | 1.006915× |
| p75 terminal | 1.009452× |
| p95 terminal | 1.010916× |

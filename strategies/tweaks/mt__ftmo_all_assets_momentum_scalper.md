# Tweak record: `mt__ftmo_all_assets_momentum_scalper`

**Title:** ftmo_all_assets_momentum_scalper  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: ftmo_all_assets_momentum_scalper (.mq5)`  
**Adapter profile:** `momentum`  
...
Profile `momentum` keeps this family's original signal language; accuracy layer is the shared Mark filter + TP/SL tier `A_first_breath`.
...
| Metric | Value |
|--------|------:|
| Win rate (accuracy) % | 69.1404 |
| Total trades (sum set×mode) | 351 |
| Total return % (avg set×mode) | -0.4081 |
| Max drawdown % (avg) | 0.5327 |
| Profit factor (avg) | 12.6861 |
| Sharpe (avg) | -2.1804 |
| Aggregate score | 1268.0638 |
| Runs (set×mode) | 8 |

**Delta win rate:** +43.7593 pp vs baseline.
...
**Family id:** `mt__ftmo_all_assets_momentum_scalper`  
**MC rank (by bootstrap median terminal):** **56** / 139  
...
| Historical terminal (compound order of book) | 0.967718× |
| Historical max DD | 3.5107% |
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.967331× |
| Mean terminal wealth | 0.967144× |
| p05 terminal | 0.947295× |
| p25 terminal | 0.959383× |
| p75 terminal | 0.975170× |
| p95 terminal | 0.986549× |
| P(loss) = P(terminal < 1) | 99.90% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 3.6066% |
| p95 path max DD | 5.4886% |

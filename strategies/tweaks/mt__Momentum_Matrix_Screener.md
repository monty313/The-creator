# Tweak record: `mt__Momentum_Matrix_Screener`

**Title:** Momentum_Matrix_Screener  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: Momentum_Matrix_Screener (.mq5)`  
...
**Family id:** `mt__Momentum_Matrix_Screener`  
**MC rank (by bootstrap median terminal):** **72** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.962596× |
| Mean terminal wealth | 0.962623× |
| p05 terminal | 0.933654× |
| p25 terminal | 0.951616× |
| p75 terminal | 0.974255× |
| p95 terminal | 0.991850× |
| P(loss) = P(terminal < 1) | 98.30% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 4.3799% |
| p95 path max DD | 7.1234% |

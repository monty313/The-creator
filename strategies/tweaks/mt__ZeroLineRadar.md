# Tweak record: `mt__ZeroLineRadar` (CCI upgraded)
...
**MC rank (by bootstrap median terminal):** **8** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 1.008311× |
| Mean terminal wealth | 1.008132× |
| p05 terminal | 1.004605× |
| p25 terminal | 1.006918× |
| p75 terminal | 1.009480× |
| p95 terminal | 1.010821× |

# Tweak record: `mt__JordanMomentumScreener_v7_HUD`

**Title:** JordanMomentumScreener_v7_HUD  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: JordanMomentumScreener_v7_HUD (.mq5)`  
...
**MC rank (by bootstrap median terminal):** **66** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.963736× |
| Mean terminal wealth | 0.963446× |
| p05 terminal | 0.934452× |
| p25 terminal | 0.950292× |
| p75 terminal | 0.975762× |
| p95 terminal | 0.992188× |
| P(loss) = P(terminal < 1) | 98.50% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 4.3621% |
| p95 path max DD | 7.1052% |

# Tweak record: `note__algo_guide_14_s06_parabolic_sar_md`

**Title:** s06_parabolic_sar.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\algo_guide_14\s06_parabolic_sar.md`  
**Adapter profile:** `guide_s06_psar`  
...
Guide strategy from Strategies-to-replicate HTML. Profile `guide_s06_psar` under lab shell.
...
| Metric | Value |
|--------|------:|
| Win rate (accuracy) % | 74.6956 |
| Total trades (sum set×mode) | 305 |
| Total return % (avg set×mode) | -0.1371 |
| Max drawdown % (avg) | 0.3644 |
| Profit factor (avg) | 0.6444 |
| Sharpe (avg) | -1.4960 |
| Aggregate score | 64.2096 |
| Runs (set×mode) | 8 |

**Delta win rate:** +26.1837 pp vs baseline.
...
**MC rank (by bootstrap median terminal):** **32** / 139  
...
| Historical terminal (compound order of book) | 0.989033× |
| Historical max DD | 1.1898% |
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.989217× |
| Mean terminal wealth | 0.989245× |
| p05 terminal | 0.972191× |
| p25 terminal | 0.982357× |
| p75 terminal | 0.996212× |
| p95 terminal | 1.006270× |
| P(loss) = P(terminal < 1) | 85.50% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 1.7033% |
| p95 path max DD | 3.1714% |

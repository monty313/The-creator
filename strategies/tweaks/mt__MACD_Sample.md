# Tweak record: `mt__MACD_Sample`

**Title:** MACD Sample  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: MACD Sample (.mq4)`  
...
**Family id:** `mt__MACD_Sample`  
**MC rank (by bootstrap median terminal):** **50** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.969058× |
| Mean terminal wealth | 0.969493× |
| p05 terminal | 0.938005× |
| p25 terminal | 0.957012× |
| p75 terminal | 0.982755× |
| p95 terminal | 1.001822× |
| P(loss) = P(terminal < 1) | 93.60% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 4.0865% |
| p95 path max DD | 6.9549% |

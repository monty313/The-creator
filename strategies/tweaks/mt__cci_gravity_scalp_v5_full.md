# Tweak record: `mt__cci_gravity_scalp_v5_full` (CCI upgraded)
...
**MC rank (by bootstrap median terminal):** **5** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 1.008337× |
| Mean terminal wealth | 1.008245× |
| p05 terminal | 1.005169× |
| p25 terminal | 1.006967× |
| p75 terminal | 1.009564× |
| p95 terminal | 1.010853× |

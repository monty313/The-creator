# Tweak record: `mt__TriTF_SMA_Shift_Optimizer_EA`

**Title:** TriTF_SMA_Shift_Optimizer_EA  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: TriTF_SMA_Shift_Optimizer_EA (.mq5)`  
...
**MC rank (by bootstrap median terminal):** **2** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 1.010017× |
| Mean terminal wealth | 1.010086× |
| p05 terminal | 0.991531× |
| p25 terminal | 1.002063× |
| p75 terminal | 1.018156× |
| p95 terminal | 1.028884× |
| P(loss) = P(terminal < 1) | 19.50% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 0.8926% |
| p95 path max DD | 1.7487% |

# Tweak record: `note__algo_guide_14_s09_rsi_reversion_md`

**Title:** s09_rsi_reversion.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\algo_guide_14\s09_rsi_reversion.md`  
**Adapter profile:** `guide_s09_rsi_mr`  
...
| Metric | Value |
|--------|------:|
| Win rate (accuracy) % | 50.5403 |
| Note | From prior full-batch / sauces report if present; else 0 |

## What was changed (full detail)

### Tier selected: `D_no_session`

| Parameter | Value | Role |
|-----------|------:|------|
| tp_stop | 0.00012 | Take first unit of progress (~pips on EURUSD) |
| sl_stop | 0.0014 | Invalidate failed thesis |
...
Guide strategy from Strategies-to-replicate HTML. Profile `guide_s09_rsi_mr` under lab shell.
...
| Metric | Value |
|--------|------:|
| Win rate (accuracy) % | 76.4706 |
| Total trades (sum set×mode) | 34 |
| Total return % (avg set×mode) | -0.0856 |
| Max drawdown % (avg) | 0.1634 |
| Profit factor (avg) | 37.1797 |
| Sharpe (avg) | -0.7256 |
| Aggregate score | 3717.8444 |
| Runs (set×mode) | 8 |

**Delta win rate:** +25.9303 pp vs baseline.
...
**MC rank (by bootstrap median terminal):** **28** / 139  
...
| Historical terminal (compound order of book) | 0.995937× |
| Historical max DD | 0.5373% |
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.995916× |
| Mean terminal wealth | 0.995902× |
| p05 terminal | 0.989353× |
| p25 terminal | 0.993334× |
| p75 terminal | 0.998541× |
| p95 terminal | 1.002231× |
| P(loss) = P(terminal < 1) | 84.30% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 0.5594% |
| p95 path max DD | 1.1210% |

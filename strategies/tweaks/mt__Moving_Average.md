# Tweak record: `mt__Moving_Average`

**Title:** Moving Average  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: Moving Average (.mq4)`  
...
**MC rank (by bootstrap median terminal):** **79** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.949203× |
| Mean terminal wealth | 0.948574× |
| p05 terminal | 0.912679× |
| p25 terminal | 0.933734× |
| p75 terminal | 0.963875× |
| p95 terminal | 0.983680× |
| P(loss) = P(terminal < 1) | 99.10% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 5.9019% |
| p95 path max DD | 9.2168% |

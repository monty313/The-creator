# Tweak record: `mt__NN_CCI_Screener_Simple`

**Title:** NN_CCI_Screener_Simple  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: NN_CCI_Screener_Simple (.mq5)`  
...
**Family id:** `mt__NN_CCI_Screener_Simple`  
**MC rank (by bootstrap median terminal):** **124** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.939519× |
| Mean terminal wealth | 0.939820× |
| p05 terminal | 0.901203× |
| p25 terminal | 0.923843× |
| p75 terminal | 0.954741× |
| p95 terminal | 0.979701× |
| P(loss) = P(terminal < 1) | 99.50% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.7740% |
| p95 path max DD | 10.2938% |

# Tweak record: `mt__play_4_2`

**Title:** play 4.2  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: play 4.2 (.mq5)`  
...
**Family id:** `mt__play_4_2`  
**MC rank (by bootstrap median terminal):** **71** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.962710× |
| Mean terminal wealth | 0.962411× |
| p05 terminal | 0.934028× |
| p25 terminal | 0.950290× |
| p75 terminal | 0.974573× |
| p95 terminal | 0.991917× |
| P(loss) = P(terminal < 1) | 98.30% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 4.3907% |
| p95 path max DD | 7.0060% |

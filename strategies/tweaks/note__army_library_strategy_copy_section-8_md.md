# Tweak record: `note__army_library_strategy_copy_section-8_md`

**Title:** section-8.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\army_library_strategy_copy\section-8.md`  
...
**Family id:** `note__army_library_strategy_copy_section-8_md`  
**MC rank (by bootstrap median terminal):** **93** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.941060× |
| Mean terminal wealth | 0.941195× |
| p05 terminal | 0.902761× |
| p25 terminal | 0.925107× |
| p75 terminal | 0.956703× |
| p95 terminal | 0.979980× |
| P(loss) = P(terminal < 1) | 99.70% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.6720% |
| p95 path max DD | 10.2521% |

# Tweak record: `mt__Pure_CCI_Screener` (CCI upgraded)
...
**MC rank (by bootstrap median terminal):** **7** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 1.008327× |
| Mean terminal wealth | 1.008187× |
| p05 terminal | 1.004453× |
| p25 terminal | 1.006991× |
| p75 terminal | 1.009540× |
| p95 terminal | 1.010914× |

# Tweak record: `mt__ftmo_challenge_ea_v3`

**Title:** ftmo_challenge_ea_v3  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: ftmo_challenge_ea_v3 (.mq5)`  
...
**MC rank (by bootstrap median terminal):** **135** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.926515× |
| Mean terminal wealth | 0.926125× |
| p05 terminal | 0.891231× |
| p25 terminal | 0.912284× |
| p75 terminal | 0.940798× |
| p95 terminal | 0.959387× |
| P(loss) = P(terminal < 1) | 100.00% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 7.8968% |
| p95 path max DD | 11.3813% |

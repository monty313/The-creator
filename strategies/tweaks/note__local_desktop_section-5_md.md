# Tweak record: `note__local_desktop_section-5_md`

**Title:** section-5.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\local_desktop\section-5.md`  
...
**Family id:** `note__local_desktop_section-5_md`  
**MC rank (by bootstrap median terminal):** **111** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.940207× |
| Mean terminal wealth | 0.940719× |
| p05 terminal | 0.904817× |
| p25 terminal | 0.925609× |
| p75 terminal | 0.956628× |
| p95 terminal | 0.978831× |
| P(loss) = P(terminal < 1) | 99.70% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.6892% |
| p95 path max DD | 9.9672% |

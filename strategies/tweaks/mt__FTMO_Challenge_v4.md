# Tweak record: `mt__FTMO_Challenge_v4`

**Title:** FTMO_Challenge_v4  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: FTMO_Challenge_v4 (.mq5)`  
...
**Family id:** `mt__FTMO_Challenge_v4`  
**MC rank (by bootstrap median terminal):** **131** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.927363× |
| Mean terminal wealth | 0.927349× |
| p05 terminal | 0.891372× |
| p25 terminal | 0.913225× |
| p75 terminal | 0.941548× |
| p95 terminal | 0.961756× |
| P(loss) = P(terminal < 1) | 99.90% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 7.7354% |
| p95 path max DD | 11.1010% |

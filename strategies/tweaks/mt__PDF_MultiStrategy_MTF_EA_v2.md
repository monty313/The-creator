# Tweak record: `mt__PDF_MultiStrategy_MTF_EA_v2`

**Title:** PDF_MultiStrategy_MTF_EA_v2  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: PDF_MultiStrategy_MTF_EA_v2 (.mq5)`  
...
**Family id:** `mt__PDF_MultiStrategy_MTF_EA_v2`  
**MC rank (by bootstrap median terminal):** **99** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.940851× |
| Mean terminal wealth | 0.941044× |
| p05 terminal | 0.903264× |
| p25 terminal | 0.924871× |
| p75 terminal | 0.957031× |
| p95 terminal | 0.980632× |
| P(loss) = P(terminal < 1) | 99.50% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.6558% |
| p95 path max DD | 10.1794% |

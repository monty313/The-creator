# Tweak record: `mt__MA_ribbon_filled_Alerts`

**Title:** MA ribbon filled_Alerts  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: MA ribbon filled_Alerts (.mq4)`  
**Adapter profile:** `ma_ribbon`  
...
Profile `ma_ribbon` keeps this family's original signal language; accuracy layer is the shared Mark filter + TP/SL tier `A_first_breath`.
...
**MC rank (by bootstrap median terminal):** **139** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.906525× |
| Mean terminal wealth | 0.906775× |
| p05 terminal | 0.866054× |
| p25 terminal | 0.888843× |
| p75 terminal | 0.924063× |
| p95 terminal | 0.951243× |
| P(loss) = P(terminal < 1) | 99.90% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 9.9612% |
| p95 path max DD | 13.9149% |

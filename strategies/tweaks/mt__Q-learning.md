# Tweak record: `mt__Q-learning`

**Title:** Q-learning  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: Q-learning (.mq5)`  
...
**Family id:** `mt__Q-learning`  
**MC rank (by bootstrap median terminal):** **51** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.968772× |
| Mean terminal wealth | 0.968721× |
| p05 terminal | 0.935636× |
| p25 terminal | 0.956219× |
| p75 terminal | 0.982561× |
| p95 terminal | 1.001094× |
| P(loss) = P(terminal < 1) | 94.20% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 4.1473% |
| p95 path max DD | 7.0555% |

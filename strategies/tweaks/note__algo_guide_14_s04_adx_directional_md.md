# Tweak record: `note__algo_guide_14_s04_adx_directional_md`

**Title:** s04_adx_directional.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\algo_guide_14\s04_adx_directional.md`  
**Adapter profile:** `guide_s04_adx_di`  
...
Guide strategy from Strategies-to-replicate HTML. Profile `guide_s04_adx_di` under lab shell.
...
| Metric | Value |
|--------|------:|
| Win rate (accuracy) % | 73.2984 |
| Total trades (sum set×mode) | 573 |
| Total return % (avg set×mode) | -0.5048 |
| Max drawdown % (avg) | 0.8166 |
| Profit factor (avg) | 12.9872 |
| Sharpe (avg) | -2.2957 |
| Aggregate score | 1298.0118 |
| Runs (set×mode) | 8 |

**Delta win rate:** +32.7764 pp vs baseline.
...
**MC rank (by bootstrap median terminal):** **74** / 139  
...
| Historical terminal (compound order of book) | 0.960129× |
| Historical max DD | 4.1930% |
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.959583× |
| Mean terminal wealth | 0.959499× |
| p05 terminal | 0.930743× |
| p25 terminal | 0.948041× |
| p75 terminal | 0.971381× |
| p95 terminal | 0.988443× |
| P(loss) = P(terminal < 1) | 99.00% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 4.6405% |
| p95 path max DD | 7.3160% |

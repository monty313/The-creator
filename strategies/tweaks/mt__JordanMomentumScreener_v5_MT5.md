# Tweak record: `mt__JordanMomentumScreener_v5_MT5`

**Title:** JordanMomentumScreener_v5_MT5  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: JordanMomentumScreener_v5_MT5 (.mq5)`  
...
**Family id:** `mt__JordanMomentumScreener_v5_MT5`  
**MC rank (by bootstrap median terminal):** **68** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.963457× |
| Mean terminal wealth | 0.962928× |
| p05 terminal | 0.933879× |
| p25 terminal | 0.950497× |
| p75 terminal | 0.974043× |
| p95 terminal | 0.992246× |
| P(loss) = P(terminal < 1) | 98.60% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 4.3531% |
| p95 path max DD | 7.0468% |

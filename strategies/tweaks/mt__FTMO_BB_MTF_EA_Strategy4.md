# Tweak record: `mt__FTMO_BB_MTF_EA_Strategy4`

**Title:** FTMO_BB_MTF_EA_Strategy4  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: FTMO_BB_MTF_EA_Strategy4 (.mq5)`  
...
**Family id:** `mt__FTMO_BB_MTF_EA_Strategy4`  
**MC rank (by bootstrap median terminal):** **25** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 1.002074× |
| Mean terminal wealth | 1.002263× |
| p05 terminal | 0.986776× |
| p25 terminal | 0.995808× |
| p75 terminal | 1.008616× |
| p95 terminal | 1.018755× |
| P(loss) = P(terminal < 1) | 41.50% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 0.9948% |
| p95 path max DD | 1.9997% |

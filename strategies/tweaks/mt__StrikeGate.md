# Tweak record: `mt__StrikeGate` (CCI upgraded)
...
**Family id:** `mt__StrikeGate`  
**MC rank (by bootstrap median terminal):** **12** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 1.008258× |
| Mean terminal wealth | 1.008197× |
| p05 terminal | 1.005270× |
| p25 terminal | 1.006957× |
| p75 terminal | 1.009479× |
| p95 terminal | 1.010905× |

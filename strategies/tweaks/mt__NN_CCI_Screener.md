# Tweak record: `mt__NN_CCI_Screener`

**Title:** NN_CCI_Screener  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: NN_CCI_Screener (.mq5)`  
...
**Family id:** `mt__NN_CCI_Screener`  
**MC rank (by bootstrap median terminal):** **118** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.939797× |
| Mean terminal wealth | 0.940636× |
| p05 terminal | 0.905244× |
| p25 terminal | 0.926063× |
| p75 terminal | 0.955678× |
| p95 terminal | 0.979716× |
| P(loss) = P(terminal < 1) | 99.50% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.7502% |
| p95 path max DD | 9.9711% |

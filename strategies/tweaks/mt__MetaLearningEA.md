# Tweak record: `mt__MetaLearningEA`

**Title:** MetaLearningEA  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: MetaLearningEA (.mq5)`  
...
**Family id:** `mt__MetaLearningEA`  
**MC rank (by bootstrap median terminal):** **109** / 139  
...
| Mean terminal wealth | 0.940265× |
| p05 terminal | 0.903562× |
| p25 terminal | 0.925583× |
| p75 terminal | 0.954236× |
| p95 terminal | 0.977536× |
| P(loss) = P(terminal < 1) | 99.30% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.7905% |
| p95 path max DD | 10.0153% |

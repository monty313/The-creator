# Tweak record: `mt__NeuralNetworkScreener_Simple`

**Title:** NeuralNetworkScreener_Simple  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: NeuralNetworkScreener_Simple (.mq5)`  
...
**Family id:** `mt__NeuralNetworkScreener_Simple`  
**MC rank (by bootstrap median terminal):** **116** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.939992× |
| Mean terminal wealth | 0.940297× |
| p05 terminal | 0.901161× |
| p25 terminal | 0.924748× |
| p75 terminal | 0.955505× |
| p95 terminal | 0.976084× |
| P(loss) = P(terminal < 1) | 98.80% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.7393% |
| p95 path max DD | 10.3455% |

# Tweak record: `mt__ftmo_ultra`

**Title:** ftmo ultra  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: ftmo ultra (.mq5)`  
...
**Family id:** `mt__ftmo_ultra`  
**MC rank (by bootstrap median terminal):** **58** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.967132× |
| Mean terminal wealth | 0.967582× |
| p05 terminal | 0.947373× |
| p25 terminal | 0.959238× |
| p75 terminal | 0.976123× |
| p95 terminal | 0.987922× |
| P(loss) = P(terminal < 1) | 99.40% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 3.6393% |
| p95 path max DD | 5.4825% |

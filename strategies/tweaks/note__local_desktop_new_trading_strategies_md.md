# Tweak record: `note__local_desktop_new_trading_strategies_md`
...
**Family id:** `note__local_desktop_new_trading_strategies_md`  
**MC rank (by bootstrap median terminal):** **86** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.941370× |
| Mean terminal wealth | 0.941697× |
| p05 terminal | 0.900995× |
| p25 terminal | 0.926526× |
| p75 terminal | 0.957255× |
| p95 terminal | 0.978735× |
| P(loss) = P(terminal < 1) | 99.40% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.6619% |
| p95 path max DD | 10.2655% |

# Tweak record: `mt__US30_ExpansionTrigger_v1`

**Title:** US30_ExpansionTrigger_v1  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: US30_ExpansionTrigger_v1 (.mq5)`  
...
**MC rank (by bootstrap median terminal):** **52** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.968205× |
| Mean terminal wealth | 0.967990× |
| p05 terminal | 0.948587× |
| p25 terminal | 0.959875× |
| p75 terminal | 0.976208× |
| p95 terminal | 0.987059× |
| P(loss) = P(terminal < 1) | 99.70% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 3.5359% |
| p95 path max DD | 5.3872% |

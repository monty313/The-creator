# Tweak record: `mt__FTMO_BB_MTF_EA_Strategy4_20260705_1210`

**Title:** FTMO_BB_MTF_EA_Strategy4_20260705_1210  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: FTMO_BB_MTF_EA_Strategy4_20260705_1210 (.mq5)`  
...
**Family id:** `mt__FTMO_BB_MTF_EA_Strategy4_20260705_1210`  
**MC rank (by bootstrap median terminal):** **24** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 1.002345× |
| Mean terminal wealth | 1.002373× |
| p05 terminal | 0.985256× |
| p25 terminal | 0.995953× |
| p75 terminal | 1.008779× |
| p95 terminal | 1.018250× |
| P(loss) = P(terminal < 1) | 40.50% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 0.9812% |
| p95 path max DD | 2.0475% |

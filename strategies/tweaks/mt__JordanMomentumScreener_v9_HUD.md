# Tweak record: `mt__JordanMomentumScreener_v9_HUD`

**Title:** JordanMomentumScreener_v9_HUD  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: JordanMomentumScreener_v9_HUD (.mq5)`  
...
**Family id:** `mt__JordanMomentumScreener_v9_HUD`  
**MC rank (by bootstrap median terminal):** **69** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.963450× |
| Mean terminal wealth | 0.963272× |
| p05 terminal | 0.935672× |
| p25 terminal | 0.951121× |
| p75 terminal | 0.974297× |
| p95 terminal | 0.992626× |
| P(loss) = P(terminal < 1) | 97.70% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 4.3890% |
| p95 path max DD | 6.8971% |

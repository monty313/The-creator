# Tweak record: `mt__Unity_Play`

**Title:** Unity Play  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: Unity Play (.mq5)`  
...
**Family id:** `mt__Unity_Play`  
**MC rank (by bootstrap median terminal):** **73** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.962464× |
| Mean terminal wealth | 0.962551× |
| p05 terminal | 0.933903× |
| p25 terminal | 0.951234× |
| p75 terminal | 0.973884× |
| p95 terminal | 0.991358× |
| P(loss) = P(terminal < 1) | 98.40% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 4.3776% |
| p95 path max DD | 7.0223% |

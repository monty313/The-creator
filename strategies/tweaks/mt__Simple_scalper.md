# Tweak record: `mt__Simple_scalper`

**Title:** Simple scalper  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: Simple scalper (.mq5)`  
...
**Family id:** `mt__Simple_scalper`  
**MC rank (by bootstrap median terminal):** **55** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.967646× |
| Mean terminal wealth | 0.967286× |
| p05 terminal | 0.946416× |
| p25 terminal | 0.958634× |
| p75 terminal | 0.976042× |
| p95 terminal | 0.987529× |
| P(loss) = P(terminal < 1) | 99.70% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 3.5879% |
| p95 path max DD | 5.4751% |

# Tweak record: `mt__FTMO_Challenge_EA_FULL`

**Title:** FTMO_Challenge_EA_FULL  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: FTMO_Challenge_EA_FULL (.mq5)`  
...
**MC rank (by bootstrap median terminal):** **137** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.925601× |
| Mean terminal wealth | 0.926256× |
| p05 terminal | 0.892565× |
| p25 terminal | 0.910412× |
| p75 terminal | 0.940570× |
| p95 terminal | 0.962685× |
| P(loss) = P(terminal < 1) | 99.80% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 8.0165% |
| p95 path max DD | 11.2117% |

# Tweak record: `note__algo_guide_14_s07_ema_ribbon_md`

**Title:** s07_ema_ribbon.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\algo_guide_14\s07_ema_ribbon.md`  
**Adapter profile:** `guide_s07_ema_ribbon`  
...
Guide strategy from Strategies-to-replicate HTML. Profile `guide_s07_ema_ribbon` under lab shell.
...
| Metric | Value |
|--------|------:|
| Win rate (accuracy) % | 70.5925 |
| Total trades (sum set×mode) | 1585 |
| Total return % (avg set×mode) | -1.2125 |
| Max drawdown % (avg) | 1.6945 |
| Profit factor (avg) | 0.7929 |
| Sharpe (avg) | -4.1853 |
| Aggregate score | 77.6534 |
| Runs (set×mode) | 8 |

**Delta win rate:** +34.3663 pp vs baseline.
...
**MC rank (by bootstrap median terminal):** **138** / 139  
...
| Historical terminal (compound order of book) | 0.906548× |
| Historical max DD | 9.4364% |
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.906686× |
| Mean terminal wealth | 0.907377× |
| p05 terminal | 0.865345× |
| p25 terminal | 0.889431× |
| p75 terminal | 0.925468× |
| p95 terminal | 0.948965× |
| P(loss) = P(terminal < 1) | 100.00% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 9.8770% |
| p95 path max DD | 13.8379% |

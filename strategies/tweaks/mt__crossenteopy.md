# Tweak record: `mt__crossenteopy`

**Title:** crossenteopy  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: crossenteopy (.mq5)`  
...
**Family id:** `mt__crossenteopy`  
**MC rank (by bootstrap median terminal):** **45** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.969626× |
| Mean terminal wealth | 0.969608× |
| p05 terminal | 0.935308× |
| p25 terminal | 0.956734× |
| p75 terminal | 0.983008× |
| p95 terminal | 1.002706× |
| P(loss) = P(terminal < 1) | 93.70% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 3.9613% |
| p95 path max DD | 7.0318% |

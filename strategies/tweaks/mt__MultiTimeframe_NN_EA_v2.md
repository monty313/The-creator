# Tweak record: `mt__MultiTimeframe_NN_EA_v2`

**Title:** MultiTimeframe_NN_EA_v2  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: MultiTimeframe_NN_EA_v2 (.mq5)`  
...
**Family id:** `mt__MultiTimeframe_NN_EA_v2`  
**MC rank (by bootstrap median terminal):** **84** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.941505× |
| Mean terminal wealth | 0.941858× |
| p05 terminal | 0.905707× |
| p25 terminal | 0.925557× |
| p75 terminal | 0.958380× |
| p95 terminal | 0.979842× |
| P(loss) = P(terminal < 1) | 99.50% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.6331% |
| p95 path max DD | 10.1464% |

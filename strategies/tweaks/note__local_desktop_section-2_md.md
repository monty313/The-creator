# Tweak record: `note__local_desktop_section-2_md`

**Title:** section-2.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\local_desktop\section-2.md`  
...
**Family id:** `note__local_desktop_section-2_md`  
**MC rank (by bootstrap median terminal):** **106** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.940279× |
| Mean terminal wealth | 0.940649× |
| p05 terminal | 0.900638× |
| p25 terminal | 0.925543× |
| p75 terminal | 0.955961× |
| p95 terminal | 0.979238× |
| P(loss) = P(terminal < 1) | 99.50% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.7289% |
| p95 path max DD | 10.3654% |

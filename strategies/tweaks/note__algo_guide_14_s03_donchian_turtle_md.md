# Tweak record: `note__algo_guide_14_s03_donchian_turtle_md`

**Title:** s03_donchian_turtle.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\algo_guide_14\s03_donchian_turtle.md`  
**Adapter profile:** `guide_s03_donchian_turtle`  
...
Guide strategy from Strategies-to-replicate HTML. Profile `guide_s03_donchian_turtle` under lab shell.
...
| Metric | Value |
|--------|------:|
| Win rate (accuracy) % | 74.3089 |
| Total trades (sum set×mode) | 573 |
| Total return % (avg set×mode) | -0.3791 |
| Max drawdown % (avg) | 0.7714 |
| Profit factor (avg) | 13.1957 |
| Sharpe (avg) | -1.5148 |
| Aggregate score | 1319.0011 |
| Runs (set×mode) | 8 |

**Delta win rate:** +33.3199 pp vs baseline.
...
**MC rank (by bootstrap median terminal):** **42** / 139  
...
| Historical terminal (compound order of book) | 0.969839× |
| Historical max DD | 3.7575% |
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.971142× |
| Mean terminal wealth | 0.970767× |
| p05 terminal | 0.943607× |
| p25 terminal | 0.959740× |
| p75 terminal | 0.981850× |
| p95 terminal | 0.997515× |
| P(loss) = P(terminal < 1) | 96.50% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 3.6201% |
| p95 path max DD | 6.1149% |

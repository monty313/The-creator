...
**Family id:** `mt__FTMO_DQN`  
**MC rank (by bootstrap median terminal):** **101** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.940768× |
| Mean terminal wealth | 0.941000× |
| p05 terminal | 0.905554× |
| p25 terminal | 0.925939× |
| p75 terminal | 0.954757× |
| p95 terminal | 0.977407× |
| P(loss) = P(terminal < 1) | 99.30% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.6769% |
| p95 path max DD | 9.9126% |

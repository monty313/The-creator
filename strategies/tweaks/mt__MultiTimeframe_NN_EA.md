# Tweak record: `mt__MultiTimeframe_NN_EA`

**Title:** MultiTimeframe_NN_EA  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: MultiTimeframe_NN_EA (.mq5)`  
...
**Family id:** `mt__MultiTimeframe_NN_EA`  
**MC rank (by bootstrap median terminal):** **115** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.939994× |
| Mean terminal wealth | 0.940083× |
| p05 terminal | 0.903744× |
| p25 terminal | 0.925138× |
| p75 terminal | 0.955067× |
| p95 terminal | 0.977022× |
| P(loss) = P(terminal < 1) | 99.40% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.7738% |
| p95 path max DD | 10.1181% |

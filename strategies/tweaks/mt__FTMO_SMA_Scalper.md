# Tweak record: `mt__FTMO_SMA_Scalper`

**Title:** FTMO_SMA_Scalper  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: FTMO_SMA_Scalper (.mq5)`  
...
**Family id:** `mt__FTMO_SMA_Scalper`  
**MC rank (by bootstrap median terminal):** **3** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 1.009612× |
| Mean terminal wealth | 1.009925× |
| p05 terminal | 0.992459× |
| p25 terminal | 1.003064× |
| p75 terminal | 1.016796× |
| p95 terminal | 1.027438× |
| P(loss) = P(terminal < 1) | 17.70% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 0.8793% |
| p95 path max DD | 1.7126% |

# Tweak record: `mt__S11_Runner`

**Title:** S11_Runner  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: S11_Runner (.mq5)`  
...
**Family id:** `mt__S11_Runner`  
**MC rank (by bootstrap median terminal):** **134** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.926773× |
| Mean terminal wealth | 0.926894× |
| p05 terminal | 0.890557× |
| p25 terminal | 0.912575× |
| p75 terminal | 0.941728× |
| p95 terminal | 0.962761× |
| P(loss) = P(terminal < 1) | 100.00% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 7.8646% |
| p95 path max DD | 11.1917% |

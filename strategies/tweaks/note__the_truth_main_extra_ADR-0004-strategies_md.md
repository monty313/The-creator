# Tweak record: `note__the_truth_main_extra_ADR-0004-strategies_md`

**Title:** ADR-0004-strategies.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\the_truth_main_extra\ADR-0004-strategies.md`  
...
**MC rank (by bootstrap median terminal):** **40** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.974426× |
| Mean terminal wealth | 0.975035× |
| p05 terminal | 0.953446× |
| p25 terminal | 0.965633× |
| p75 terminal | 0.983696× |
| p95 terminal | 0.997600× |
| P(loss) = P(terminal < 1) | 96.40% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 3.0399% |
| p95 path max DD | 5.0286% |

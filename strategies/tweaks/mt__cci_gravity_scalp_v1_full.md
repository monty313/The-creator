# Tweak record: `mt__cci_gravity_scalp_v1_full` (CCI upgraded)
...
**MC rank (by bootstrap median terminal):** **6** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 1.008331× |
| Mean terminal wealth | 1.008310× |
| p05 terminal | 1.005124× |
| p25 terminal | 1.007102× |
| p75 terminal | 1.009593× |
| p95 terminal | 1.010968× |

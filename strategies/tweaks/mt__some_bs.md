# Tweak record: `mt__some_bs`

**Title:** some bs  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: some bs (.mq5)`  
...
**Family id:** `mt__some_bs`  
**MC rank (by bootstrap median terminal):** **47** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.969352× |
| Mean terminal wealth | 0.968964× |
| p05 terminal | 0.936675× |
| p25 terminal | 0.955875× |
| p75 terminal | 0.982306× |
| p95 terminal | 0.999934× |
| P(loss) = P(terminal < 1) | 95.00% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 4.0922% |
| p95 path max DD | 6.8311% |

# Tweak record: `mt__AutoGKCloseIntegral`

**Title:** AutoGKCloseIntegral  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: AutoGKCloseIntegral (.mq5)`  
...
**MC rank (by bootstrap median terminal):** **80** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.949154× |
| Mean terminal wealth | 0.949558× |
| p05 terminal | 0.912134× |
| p25 terminal | 0.935040× |
| p75 terminal | 0.964334× |
| p95 terminal | 0.986433× |
| P(loss) = P(terminal < 1) | 99.00% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 5.8389% |
| p95 path max DD | 9.1946% |

# Tweak record: `mt__JordanMomentumScreener_v11`

**Title:** JordanMomentumScreener_v11  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: JordanMomentumScreener_v11 (.mq5)`  
...
**Family id:** `mt__JordanMomentumScreener_v11`  
**MC rank (by bootstrap median terminal):** **62** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.964270× |
| Mean terminal wealth | 0.964224× |
| p05 terminal | 0.934419× |
| p25 terminal | 0.951484× |
| p75 terminal | 0.976691× |
| p95 terminal | 0.994195× |
| P(loss) = P(terminal < 1) | 97.60% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 4.2497% |
| p95 path max DD | 6.8418% |

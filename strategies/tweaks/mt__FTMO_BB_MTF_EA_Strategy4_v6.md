# Tweak record: `mt__FTMO_BB_MTF_EA_Strategy4_v6`

**Title:** FTMO_BB_MTF_EA_Strategy4_v6  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: FTMO_BB_MTF_EA_Strategy4_v6 (.mq5)`  
...
**Family id:** `mt__FTMO_BB_MTF_EA_Strategy4_v6`  
**MC rank (by bootstrap median terminal):** **22** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 1.002791× |
| Mean terminal wealth | 1.003047× |
| p05 terminal | 0.987112× |
| p25 terminal | 0.996935× |
| p75 terminal | 1.009333× |
| p95 terminal | 1.020034× |
| P(loss) = P(terminal < 1) | 36.80% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 0.9450% |
| p95 path max DD | 1.8634% |

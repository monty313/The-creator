# Tweak record: `note__army_library_strategy_copy_rsi_bb_strategy_txt`

**Title:** rsi + bb strategy.txt  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\army_library_strategy_copy\rsi + bb strategy.txt`  
...
**Family id:** `note__army_library_strategy_copy_rsi_bb_strategy_txt`  
**MC rank (by bootstrap median terminal):** **97** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.940966× |
| Mean terminal wealth | 0.941973× |
| p05 terminal | 0.904716× |
| p25 terminal | 0.925875× |
| p75 terminal | 0.957678× |
| p95 terminal | 0.982017× |
| P(loss) = P(terminal < 1) | 99.20% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.6376% |
| p95 path max DD | 9.9872% |

# Tweak record: `mt__to_opimize_ea`

**Title:** to opimize ea  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: to opimize ea (.mq5)`  
...
**Family id:** `mt__to_opimize_ea`  
**MC rank (by bootstrap median terminal):** **104** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.940353× |
| Mean terminal wealth | 0.939943× |
| p05 terminal | 0.903575× |
| p25 terminal | 0.925243× |
| p75 terminal | 0.954710× |
| p95 terminal | 0.976191× |
| P(loss) = P(terminal < 1) | 99.20% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.8251% |
| p95 path max DD | 10.1873% |

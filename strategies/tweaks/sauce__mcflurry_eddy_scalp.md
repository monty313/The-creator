# Tweak record: `sauce__mcflurry_eddy_scalp`

**Title:** McFlurry Eddy H001  
**Kind:** sauce  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\sauces\H001_mcflurry_eddy_scalp.md`  
**Adapter profile:** `mcflurry`  
...
Profile `mcflurry` keeps this family's original signal language; accuracy layer is the shared Mark filter + TP/SL tier `A_first_breath`.
...
| Metric | Value |
|--------|------:|
| Win rate (accuracy) % | 80.0005 |
| Total trades (sum set×mode) | 212 |
| Total return % (avg set×mode) | 0.0738 |
| Max drawdown % (avg) | 0.2898 |
| Profit factor (avg) | 13.0459 |
| Sharpe (avg) | 0.5106 |
| Aggregate score | 1304.5874 |
| Runs (set×mode) | 8 |

**Delta win rate:** +24.6915 pp vs baseline.

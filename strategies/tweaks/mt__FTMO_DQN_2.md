# Tweak record: `mt__FTMO_DQN_2`

**Title:** FTMO_DQN  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: FTMO_DQN (.mq5)`  
...
**Family id:** `mt__FTMO_DQN_2`  
**MC rank (by bootstrap median terminal):** **103** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.940682× |
| Mean terminal wealth | 0.940542× |
| p05 terminal | 0.901893× |
| p25 terminal | 0.924200× |
| p75 terminal | 0.956660× |
| p95 terminal | 0.979679× |
| P(loss) = P(terminal < 1) | 99.10% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.7287% |
| p95 path max DD | 10.2735% |

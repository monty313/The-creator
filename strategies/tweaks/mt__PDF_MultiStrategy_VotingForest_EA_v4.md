# Tweak record: `mt__PDF_MultiStrategy_VotingForest_EA_v4`

**Title:** PDF_MultiStrategy_VotingForest_EA_v4  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: PDF_MultiStrategy_VotingForest_EA_v4 (.mq5)`  
...
**Family id:** `mt__PDF_MultiStrategy_VotingForest_EA_v4`  
**MC rank (by bootstrap median terminal):** **95** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.941032× |
| Mean terminal wealth | 0.940410× |
| p05 terminal | 0.902354× |
| p25 terminal | 0.923792× |
| p75 terminal | 0.956333× |
| p95 terminal | 0.979282× |
| P(loss) = P(terminal < 1) | 99.60% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.7101% |
| p95 path max DD | 10.3257% |

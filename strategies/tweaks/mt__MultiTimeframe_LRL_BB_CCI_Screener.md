# Tweak record: `mt__MultiTimeframe_LRL_BB_CCI_Screener`

**Title:** MultiTimeframe_LRL_BB_CCI_Screener  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: MultiTimeframe_LRL_BB_CCI_Screener (.mq5)`  
...
**Family id:** `mt__MultiTimeframe_LRL_BB_CCI_Screener`  
**MC rank (by bootstrap median terminal):** **113** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.940113× |
| Mean terminal wealth | 0.939909× |
| p05 terminal | 0.903739× |
| p25 terminal | 0.923537× |
| p75 terminal | 0.955682× |
| p95 terminal | 0.977994× |
| P(loss) = P(terminal < 1) | 99.20% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.7954% |
| p95 path max DD | 10.1951% |

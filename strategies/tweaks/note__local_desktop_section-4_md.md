# Tweak record: `note__local_desktop_section-4_md`

**Title:** section-4.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\local_desktop\section-4.md`  
...
**Family id:** `note__local_desktop_section-4_md`  
**MC rank (by bootstrap median terminal):** **127** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.938713× |
| Mean terminal wealth | 0.939922× |
| p05 terminal | 0.903526× |
| p25 terminal | 0.924810× |
| p75 terminal | 0.955546× |
| p95 terminal | 0.977015× |
| P(loss) = P(terminal < 1) | 99.60% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.7194% |
| p95 path max DD | 10.0531% |

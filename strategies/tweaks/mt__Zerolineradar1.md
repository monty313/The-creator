# Tweak record: `mt__Zerolineradar1` (CCI upgraded)
...
**MC rank (by bootstrap median terminal):** **15** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 1.008204× |
| Mean terminal wealth | 1.008126× |
| p05 terminal | 1.005121× |
| p25 terminal | 1.006883× |
| p75 terminal | 1.009446× |
| p95 terminal | 1.010805× |

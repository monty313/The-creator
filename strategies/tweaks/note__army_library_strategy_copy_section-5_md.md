# Tweak record: `note__army_library_strategy_copy_section-5_md`

**Title:** section-5.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\army_library_strategy_copy\section-5.md`  
...
**Family id:** `note__army_library_strategy_copy_section-5_md`  
**MC rank (by bootstrap median terminal):** **90** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.941180× |
| Mean terminal wealth | 0.941085× |
| p05 terminal | 0.905131× |
| p25 terminal | 0.925647× |
| p75 terminal | 0.956344× |
| p95 terminal | 0.977233× |
| P(loss) = P(terminal < 1) | 99.70% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.6565% |
| p95 path max DD | 10.0360% |

# Tweak record: `note__algo_guide_14_s02_breakout_trading_md`

**Title:** s02_breakout_trading.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\algo_guide_14\s02_breakout_trading.md`  
**Adapter profile:** `guide_s02_breakout`  
...
Guide strategy from Strategies-to-replicate HTML. Profile `guide_s02_breakout` under lab shell.
...
| Metric | Value |
|--------|------:|
| Win rate (accuracy) % | 74.5659 |
| Total trades (sum set×mode) | 1032 |
| Total return % (avg set×mode) | -0.5215 |
| Max drawdown % (avg) | 1.1443 |
| Profit factor (avg) | 0.9051 |
| Sharpe (avg) | -1.8972 |
| Aggregate score | 89.7067 |
| Runs (set×mode) | 8 |

**Delta win rate:** +34.4905 pp vs baseline.
...
**MC rank (by bootstrap median terminal):** **75** / 139  
...
| Historical terminal (compound order of book) | 0.958897× |
| Historical max DD | 4.5713% |
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.958035× |
| Mean terminal wealth | 0.958309× |
| p05 terminal | 0.917903× |
| p25 terminal | 0.942730× |
| p75 terminal | 0.973532× |
| p95 terminal | 0.997153× |
| P(loss) = P(terminal < 1) | 96.40% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 5.1321% |
| p95 path max DD | 8.8506% |

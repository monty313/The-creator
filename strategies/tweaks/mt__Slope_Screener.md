# Tweak record: `mt__Slope_Screener`

**Title:** Slope_Screener  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: Slope_Screener (.mq5)`  
...
**Family id:** `mt__Slope_Screener`  
**MC rank (by bootstrap median terminal):** **81** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.948546× |
| Mean terminal wealth | 0.949728× |
| p05 terminal | 0.915599× |
| p25 terminal | 0.935331× |
| p75 terminal | 0.964363× |
| p95 terminal | 0.985431× |
| P(loss) = P(terminal < 1) | 98.80% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 5.8821% |
| p95 path max DD | 8.9964% |

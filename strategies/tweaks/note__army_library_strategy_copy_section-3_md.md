# Tweak record: `note__army_library_strategy_copy_section-3_md`

**Title:** section-3.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\army_library_strategy_copy\section-3.md`  
...
**Family id:** `note__army_library_strategy_copy_section-3_md`  
**MC rank (by bootstrap median terminal):** **107** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.940261× |
| Mean terminal wealth | 0.940507× |
| p05 terminal | 0.901246× |
| p25 terminal | 0.924150× |
| p75 terminal | 0.957143× |
| p95 terminal | 0.980632× |
| P(loss) = P(terminal < 1) | 99.70% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.7485% |
| p95 path max DD | 10.3587% |

# Tweak record: `note__algo_guide_14_s11_keltner_reversion_md`

**Title:** s11_keltner_reversion.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\algo_guide_14\s11_keltner_reversion.md`  
**Adapter profile:** `guide_s11_keltner_mr`  
...
Guide strategy from Strategies-to-replicate HTML. Profile `guide_s11_keltner_mr` under lab shell.
...
| Metric | Value |
|--------|------:|
| Win rate (accuracy) % | 73.9130 |
| Total trades (sum set×mode) | 46 |
| Total return % (avg set×mode) | -0.0633 |
| Max drawdown % (avg) | 0.1498 |
| Profit factor (avg) | 62.0534 |
| Sharpe (avg) | 0.8575 |
| Aggregate score | 6205.2430 |
| Runs (set×mode) | 8 |

**Delta win rate:** +9.0943 pp vs baseline.
...
**MC rank (by bootstrap median terminal):** **29** / 139  
...
| Historical terminal (compound order of book) | 0.994941× |
| Historical max DD | 0.6985% |
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.995268× |
| Mean terminal wealth | 0.994936× |
| p05 terminal | 0.986613× |
| p25 terminal | 0.991767× |
| p75 terminal | 0.998163× |
| p95 terminal | 1.002098× |
| P(loss) = P(terminal < 1) | 86.40% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 0.7062% |
| p95 path max DD | 1.4461% |

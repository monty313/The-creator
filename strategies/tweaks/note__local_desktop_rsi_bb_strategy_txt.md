# Tweak record: `note__local_desktop_rsi_bb_strategy_txt`

**Title:** rsi + bb strategy.txt  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\local_desktop\rsi + bb strategy.txt`  
...
**Family id:** `note__local_desktop_rsi_bb_strategy_txt`  
**MC rank (by bootstrap median terminal):** **120** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.939677× |
| Mean terminal wealth | 0.940330× |
| p05 terminal | 0.903601× |
| p25 terminal | 0.924532× |
| p75 terminal | 0.955357× |
| p95 terminal | 0.981024× |
| P(loss) = P(terminal < 1) | 99.60% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.7924% |
| p95 path max DD | 10.1678% |

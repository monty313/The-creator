# Tweak record: `mt__RL_PropTrader_Final`

**Title:** RL_PropTrader_Final  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: RL_PropTrader_Final (.mq5)`  
...
**Family id:** `mt__RL_PropTrader_Final`  
**MC rank (by bootstrap median terminal):** **92** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.941070× |
| Mean terminal wealth | 0.941064× |
| p05 terminal | 0.902333× |
| p25 terminal | 0.926009× |
| p75 terminal | 0.956440× |
| p95 terminal | 0.979077× |
| P(loss) = P(terminal < 1) | 99.50% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.6555% |
| p95 path max DD | 10.3240% |

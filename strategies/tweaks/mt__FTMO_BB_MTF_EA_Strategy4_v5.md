# Tweak record: `mt__FTMO_BB_MTF_EA_Strategy4_v5`

**Title:** FTMO_BB_MTF_EA_Strategy4_v5  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: FTMO_BB_MTF_EA_Strategy4_v5 (.mq5)`  
...
**Family id:** `mt__FTMO_BB_MTF_EA_Strategy4_v5`  
**MC rank (by bootstrap median terminal):** **20** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 1.003169× |
| Mean terminal wealth | 1.003154× |
| p05 terminal | 0.986500× |
| p25 terminal | 0.996375× |
| p75 terminal | 1.009825× |
| p95 terminal | 1.020147× |
| P(loss) = P(terminal < 1) | 36.30% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 0.9369% |
| p95 path max DD | 1.9533% |

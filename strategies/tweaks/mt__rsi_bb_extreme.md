# Tweak record: `mt__rsi_bb_extreme`

**Title:** rsi_bb_extreme  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: rsi_bb_extreme (.mq5)`  
...
**Family id:** `mt__rsi_bb_extreme`  
**MC rank (by bootstrap median terminal):** **94** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.941046× |
| Mean terminal wealth | 0.941173× |
| p05 terminal | 0.903898× |
| p25 terminal | 0.925537× |
| p75 terminal | 0.957978× |
| p95 terminal | 0.979284× |
| P(loss) = P(terminal < 1) | 99.80% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.6616% |
| p95 path max DD | 10.1578% |

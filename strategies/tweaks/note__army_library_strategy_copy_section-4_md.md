# Tweak record: `note__army_library_strategy_copy_section-4_md`

**Title:** section-4.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\army_library_strategy_copy\section-4.md`  
...
**Family id:** `note__army_library_strategy_copy_section-4_md`  
**MC rank (by bootstrap median terminal):** **83** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.941545× |
| Mean terminal wealth | 0.941784× |
| p05 terminal | 0.902842× |
| p25 terminal | 0.926356× |
| p75 terminal | 0.958132× |
| p95 terminal | 0.978417× |
| P(loss) = P(terminal < 1) | 99.20% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.6493% |
| p95 path max DD | 10.0826% |

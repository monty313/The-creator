# Tweak record: `note__algo_guide_14_s05_roc_momentum_md`

**Title:** s05_roc_momentum.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\algo_guide_14\s05_roc_momentum.md`  
**Adapter profile:** `guide_s05_roc`  
...
Guide strategy from Strategies-to-replicate HTML. Profile `guide_s05_roc` under lab shell.
...
| Metric | Value |
|--------|------:|
| Win rate (accuracy) % | 72.8602 |
| Total trades (sum set×mode) | 827 |
| Total return % (avg set×mode) | -0.3653 |
| Max drawdown % (avg) | 0.8349 |
| Profit factor (avg) | 0.8908 |
| Sharpe (avg) | -1.6808 |
| Aggregate score | 88.5103 |
| Runs (set×mode) | 8 |

**Delta win rate:** +29.7090 pp vs baseline.
...
**MC rank (by bootstrap median terminal):** **43** / 139  
...
| Historical terminal (compound order of book) | 0.970979× |
| Historical max DD | 3.1098% |
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.970505× |
| Mean terminal wealth | 0.970883× |
| p05 terminal | 0.943268× |
| p25 terminal | 0.959347× |
| p75 terminal | 0.982858× |
| p95 terminal | 0.999634× |
| P(loss) = P(terminal < 1) | 95.10% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 3.7601% |
| p95 path max DD | 6.2353% |

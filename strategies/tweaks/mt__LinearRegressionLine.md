# Tweak record: `mt__LinearRegressionLine`

**Title:** LinearRegressionLine  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: LinearRegressionLine (.mq5)`  
...
**Family id:** `mt__LinearRegressionLine`  
**MC rank (by bootstrap median terminal):** **35** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.980654× |
| Mean terminal wealth | 0.980780× |
| p05 terminal | 0.962603× |
| p25 terminal | 0.973656× |
| p75 terminal | 0.988156× |
| p95 terminal | 0.998180× |
| P(loss) = P(terminal < 1) | 97.40% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 2.3339% |
| p95 path max DD | 3.9936% |

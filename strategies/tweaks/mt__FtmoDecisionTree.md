# Tweak record: `mt__FtmoDecisionTree`

**Title:** FtmoDecisionTree  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: FtmoDecisionTree (.mq5)`  
...
**Family id:** `mt__FtmoDecisionTree`  
**MC rank (by bootstrap median terminal):** **132** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.926956× |
| Mean terminal wealth | 0.927352× |
| p05 terminal | 0.891609× |
| p25 terminal | 0.912660× |
| p75 terminal | 0.941419× |
| p95 terminal | 0.963180× |
| P(loss) = P(terminal < 1) | 100.00% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 7.8628% |
| p95 path max DD | 11.0953% |

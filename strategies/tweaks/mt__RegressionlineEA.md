# Tweak record: `mt__RegressionlineEA`

**Title:** RegressionlineEA  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: RegressionlineEA (.mq5)`  
...
**Family id:** `mt__RegressionlineEA`  
**MC rank (by bootstrap median terminal):** **96** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.940980× |
| Mean terminal wealth | 0.941231× |
| p05 terminal | 0.904382× |
| p25 terminal | 0.925932× |
| p75 terminal | 0.955873× |
| p95 terminal | 0.978265× |
| P(loss) = P(terminal < 1) | 99.60% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.6473% |
| p95 path max DD | 10.0818% |

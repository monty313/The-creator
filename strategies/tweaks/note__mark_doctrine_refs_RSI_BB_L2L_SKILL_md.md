# Tweak record: `note__mark_doctrine_refs_RSI_BB_L2L_SKILL_md`

**Title:** RSI_BB_L2L_SKILL.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\mark_doctrine_refs\RSI_BB_L2L_SKILL.md`  
...
**Family id:** `note__mark_doctrine_refs_RSI_BB_L2L_SKILL_md`  
**MC rank (by bootstrap median terminal):** **87** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.941336× |
| Mean terminal wealth | 0.941020× |
| p05 terminal | 0.903839× |
| p25 terminal | 0.925450× |
| p75 terminal | 0.956477× |
| p95 terminal | 0.979253× |
| P(loss) = P(terminal < 1) | 99.60% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.6039% |
| p95 path max DD | 10.0785% |

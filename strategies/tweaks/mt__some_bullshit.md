# Tweak record: `mt__some_bullshit`

**Title:** some bullshit  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: some bullshit (.mq5)`  
...
**MC rank (by bootstrap median terminal):** **59** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.966979× |
| Mean terminal wealth | 0.967680× |
| p05 terminal | 0.936834× |
| p25 terminal | 0.954769× |
| p75 terminal | 0.980746× |
| p95 terminal | 0.997505× |
| P(loss) = P(terminal < 1) | 95.60% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 4.1636% |
| p95 path max DD | 6.8234% |

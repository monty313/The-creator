# Tweak record: `mt__OnlineLearnerEA`

**Title:** OnlineLearnerEA  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: OnlineLearnerEA (.mq5)`  
...
**Family id:** `mt__OnlineLearnerEA`  
**MC rank (by bootstrap median terminal):** **105** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.940337× |
| Mean terminal wealth | 0.940242× |
| p05 terminal | 0.903932× |
| p25 terminal | 0.924288× |
| p75 terminal | 0.955559× |
| p95 terminal | 0.978502× |
| P(loss) = P(terminal < 1) | 99.60% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.6639% |
| p95 path max DD | 10.1114% |

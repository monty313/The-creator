# Tweak record: `mt__Momentum`

**Title:** Momentum  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: Momentum (.mq5)`  
...
**Family id:** `mt__Momentum`  
**MC rank (by bootstrap median terminal):** **53** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.968142× |
| Mean terminal wealth | 0.967832× |
| p05 terminal | 0.946715× |
| p25 terminal | 0.959649× |
| p75 terminal | 0.976195× |
| p95 terminal | 0.988207× |
| P(loss) = P(terminal < 1) | 99.50% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 3.5734% |
| p95 path max DD | 5.5757% |

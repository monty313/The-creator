# Tweak record: `note__algo_guide_14_s08_bb_mean_reversion_md`

**Title:** s08_bb_mean_reversion.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\algo_guide_14\s08_bb_mean_reversion.md`  
**Adapter profile:** `guide_s08_bb_mr`  
...
Guide strategy from Strategies-to-replicate HTML. Profile `guide_s08_bb_mr` under lab shell.
...
| Metric | Value |
|--------|------:|
| Win rate (accuracy) % | 82.3529 |
| Total trades (sum set×mode) | 34 |
| Total return % (avg set×mode) | -0.0292 |
| Max drawdown % (avg) | 0.1223 |
| Profit factor (avg) | 49.6105 |
| Sharpe (avg) | 0.8128 |
| Aggregate score | 4960.9864 |
| Runs (set×mode) | 8 |

**Delta win rate:** +33.1934 pp vs baseline.
...
**MC rank (by bootstrap median terminal):** **26** / 139  
...
| Historical terminal (compound order of book) | 0.999740× |
| Historical max DD | 0.2279% |
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 1.000028× |
| Mean terminal wealth | 0.999833× |
| p05 terminal | 0.994538× |
| p25 terminal | 0.997766× |
| p75 terminal | 1.002130× |
| p95 terminal | 1.004344× |
| P(loss) = P(terminal < 1) | 49.60% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 0.2738% |
| p95 path max DD | 0.6875% |

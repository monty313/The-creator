# Tweak record: `note__army_library_strategy_copy_new_trading_strategies_1_md`

**Title:** new_trading_strategies (1).md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\army_library_strategy_copy\new_trading_strategies (1).md`  
**Adapter profile:** `mark_rsi_bb`  
...
Profile `mark_rsi_bb` keeps this family's original signal language; accuracy layer is the shared Mark filter + TP/SL tier `A_first_breath`.
...
**Family id:** `note__army_library_strategy_copy_new_trading_strategies_1_md`  
**MC rank (by bootstrap median terminal):** **125** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.939362× |
| Mean terminal wealth | 0.940465× |
| p05 terminal | 0.902903× |
| p25 terminal | 0.925322× |
| p75 terminal | 0.954515× |
| p95 terminal | 0.980467× |
| P(loss) = P(terminal < 1) | 99.10% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.8387% |
| p95 path max DD | 10.0645% |

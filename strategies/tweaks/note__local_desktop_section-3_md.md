# Tweak record: `note__local_desktop_section-3_md`

**Title:** section-3.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\local_desktop\section-3.md`  
...
**Family id:** `note__local_desktop_section-3_md`  
**MC rank (by bootstrap median terminal):** **117** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.939936× |
| Mean terminal wealth | 0.940377× |
| p05 terminal | 0.903304× |
| p25 terminal | 0.924624× |
| p75 terminal | 0.955538× |
| p95 terminal | 0.977771× |
| P(loss) = P(terminal < 1) | 99.50% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.7186% |
| p95 path max DD | 10.1515% |

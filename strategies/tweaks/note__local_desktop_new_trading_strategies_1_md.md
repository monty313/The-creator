# Tweak record: `note__local_desktop_new_trading_strategies_1_md`

**Title:** new_trading_strategies (1).md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\local_desktop\new_trading_strategies (1).md`  
...
**Family id:** `note__local_desktop_new_trading_strategies_1_md`  
**MC rank (by bootstrap median terminal):** **126** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.939000× |
| Mean terminal wealth | 0.940045× |
| p05 terminal | 0.899933× |
| p25 terminal | 0.923873× |
| p75 terminal | 0.956098× |
| p95 terminal | 0.981253× |
| P(loss) = P(terminal < 1) | 99.70% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.8120% |
| p95 path max DD | 10.4933% |

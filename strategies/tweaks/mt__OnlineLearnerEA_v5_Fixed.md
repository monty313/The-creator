# Tweak record: `mt__OnlineLearnerEA_v5_Fixed`

**Title:** OnlineLearnerEA_v5_Fixed  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: OnlineLearnerEA_v5_Fixed (.mq5)`  
...
**Family id:** `mt__OnlineLearnerEA_v5_Fixed`  
**MC rank (by bootstrap median terminal):** **102** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.940691× |
| Mean terminal wealth | 0.940389× |
| p05 terminal | 0.901785× |
| p25 terminal | 0.923745× |
| p75 terminal | 0.955556× |
| p95 terminal | 0.978794× |
| P(loss) = P(terminal < 1) | 99.10% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.6857% |
| p95 path max DD | 10.2201% |

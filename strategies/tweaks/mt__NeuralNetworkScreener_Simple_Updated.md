# Tweak record: `mt__NeuralNetworkScreener_Simple_Updated`

**Title:** NeuralNetworkScreener_Simple_Updated  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: NeuralNetworkScreener_Simple_Updated (.mq5)`  
...
**Family id:** `mt__NeuralNetworkScreener_Simple_Updated`  
**MC rank (by bootstrap median terminal):** **114** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.940094× |
| Mean terminal wealth | 0.940503× |
| p05 terminal | 0.905013× |
| p25 terminal | 0.925955× |
| p75 terminal | 0.954215× |
| p95 terminal | 0.978875× |
| P(loss) = P(terminal < 1) | 99.30% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.7018% |
| p95 path max DD | 10.1454% |

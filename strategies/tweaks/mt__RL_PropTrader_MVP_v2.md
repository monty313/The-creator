# Tweak record: `mt__RL_PropTrader_MVP_v2`

**Title:** RL_PropTrader_MVP_v2  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: RL_PropTrader_MVP_v2 (.mq5)`  
...
**Family id:** `mt__RL_PropTrader_MVP_v2`  
**MC rank (by bootstrap median terminal):** **122** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.939660× |
| Mean terminal wealth | 0.940278× |
| p05 terminal | 0.905614× |
| p25 terminal | 0.924257× |
| p75 terminal | 0.954940× |
| p95 terminal | 0.975649× |
| P(loss) = P(terminal < 1) | 99.40% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.7994% |
| p95 path max DD | 9.9016% |

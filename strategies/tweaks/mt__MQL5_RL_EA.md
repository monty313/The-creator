# Tweak record: `mt__MQL5_RL_EA` (CCI upgraded)
...
**Family id:** `mt__MQL5_RL_EA`  
**MC rank (by bootstrap median terminal):** **14** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 1.008239× |
| Mean terminal wealth | 1.008130× |
| p05 terminal | 1.005035× |
| p25 terminal | 1.006923× |
| p75 terminal | 1.009529× |
| p95 terminal | 1.010784× |
| P(loss) = P(terminal < 1) | 0.10% |
| P(max DD ≥ 20%) | 0.00% |

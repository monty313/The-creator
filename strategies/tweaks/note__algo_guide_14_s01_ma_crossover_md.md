# Tweak record: `note__algo_guide_14_s01_ma_crossover_md`

**Title:** s01_ma_crossover.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\algo_guide_14\s01_ma_crossover.md`  
**Adapter profile:** `guide_s01_ma_cross`  
...
Guide strategy from Strategies-to-replicate HTML. Profile `guide_s01_ma_cross` under lab shell.
...
| Metric | Value |
|--------|------:|
| Win rate (accuracy) % | 77.4436 |
| Total trades (sum set×mode) | 133 |
| Total return % (avg set×mode) | -0.0077 |
| Max drawdown % (avg) | 0.2118 |
| Profit factor (avg) | 12.7827 |
| Sharpe (avg) | 0.0424 |
| Aggregate score | 1278.2132 |
| Runs (set×mode) | 8 |

**Delta win rate:** +50.9496 pp vs baseline.
...
**MC rank (by bootstrap median terminal):** **27** / 139  
...
| Historical terminal (compound order of book) | 0.999382× |
| Historical max DD | 0.6071% |
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.999743× |
| Mean terminal wealth | 0.999763× |
| p05 terminal | 0.986136× |
| p25 terminal | 0.994434× |
| p75 terminal | 1.005138× |
| p95 terminal | 1.013020× |
| P(loss) = P(terminal < 1) | 51.50% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 0.8153% |
| p95 path max DD | 1.7438% |

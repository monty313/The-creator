# Tweak record: `mt__agent_teacher`

**Title:** agent teacher  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: agent teacher (.mq5)`  
...
**Family id:** `mt__agent_teacher`  
**MC rank (by bootstrap median terminal):** **110** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.940224× |
| Mean terminal wealth | 0.940272× |
| p05 terminal | 0.904583× |
| p25 terminal | 0.924354× |
| p75 terminal | 0.955280× |
| p95 terminal | 0.979532× |
| P(loss) = P(terminal < 1) | 99.00% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.7861% |
| p95 path max DD | 10.0377% |

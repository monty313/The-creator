# Tweak record: `mt__coolboolinger`

**Title:** coolboolinger  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: coolboolinger (.mq5)`  
...
**MC rank (by bootstrap median terminal):** **128** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.936239× |
| Mean terminal wealth | 0.935587× |
| p05 terminal | 0.904353× |
| p25 terminal | 0.922921× |
| p75 terminal | 0.949189× |
| p95 terminal | 0.964687× |
| P(loss) = P(terminal < 1) | 100.00% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.8830% |
| p95 path max DD | 9.7960% |

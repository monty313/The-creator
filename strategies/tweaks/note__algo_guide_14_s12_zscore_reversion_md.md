# Tweak record: `note__algo_guide_14_s12_zscore_reversion_md`

**Title:** s12_zscore_reversion.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\algo_guide_14\s12_zscore_reversion.md`  
**Adapter profile:** `guide_s12_zscore_mr`  
...
Guide strategy from Strategies-to-replicate HTML. Profile `guide_s12_zscore_mr` under lab shell.
...
| Metric | Value |
|--------|------:|
| Win rate (accuracy) % | 75.7353 |
| Total trades (sum set×mode) | 136 |
| Total return % (avg set×mode) | -0.1082 |
| Max drawdown % (avg) | 0.2591 |
| Profit factor (avg) | 49.8194 |
| Sharpe (avg) | 0.6335 |
| Aggregate score | 4981.7673 |
| Runs (set×mode) | 8 |

**Delta win rate:** +28.1114 pp vs baseline.
...
**MC rank (by bootstrap median terminal):** **31** / 139  
...
| Historical terminal (compound order of book) | 0.991319× |
| Historical max DD | 1.3159% |
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.991648× |
| Mean terminal wealth | 0.991210× |
| p05 terminal | 0.979232× |
| p25 terminal | 0.986695× |
| p75 terminal | 0.996072× |
| p95 terminal | 1.002525× |
| P(loss) = P(terminal < 1) | 90.70% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 1.2066% |
| p95 path max DD | 2.2812% |

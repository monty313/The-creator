# Tweak record: `mt__cci_gravity_scalp_ftmo_v6_perplexity` (CCI upgraded)
...
**MC rank (by bootstrap median terminal):** **4** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 1.008386× |
| Mean terminal wealth | 1.008288× |
| p05 terminal | 1.005018× |
| p25 terminal | 1.007076× |
| p75 terminal | 1.009560× |
| p95 terminal | 1.010900× |

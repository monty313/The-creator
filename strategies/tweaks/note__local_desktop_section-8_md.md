# Tweak record: `note__local_desktop_section-8_md`

**Title:** section-8.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\local_desktop\section-8.md`  
...
**Family id:** `note__local_desktop_section-8_md`  
**MC rank (by bootstrap median terminal):** **98** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.940877× |
| Mean terminal wealth | 0.940122× |
| p05 terminal | 0.900013× |
| p25 terminal | 0.925103× |
| p75 terminal | 0.955902× |
| p95 terminal | 0.977839× |
| P(loss) = P(terminal < 1) | 99.70% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.6674% |
| p95 path max DD | 10.4855% |

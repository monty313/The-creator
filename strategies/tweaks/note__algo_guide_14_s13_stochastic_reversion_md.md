# Tweak record: `note__algo_guide_14_s13_stochastic_reversion_md`

**Title:** s13_stochastic_reversion.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\algo_guide_14\s13_stochastic_reversion.md`  
**Adapter profile:** `guide_s13_stoch_mr`  
...
Guide strategy from Strategies-to-replicate HTML. Profile `guide_s13_stoch_mr` under lab shell.
...
| Metric | Value |
|--------|------:|
| Win rate (accuracy) % | 70.9957 |
| Total trades (sum set×mode) | 408 |
| Total return % (avg set×mode) | -0.3801 |
| Max drawdown % (avg) | 0.6676 |
| Profit factor (avg) | 0.8476 |
| Sharpe (avg) | -2.5872 |
| Aggregate score | 84.2163 |
| Runs (set×mode) | 8 |

**Delta win rate:** +21.6403 pp vs baseline.
...
**MC rank (by bootstrap median terminal):** **44** / 139  
...
| Historical terminal (compound order of book) | 0.969786× |
| Historical max DD | 3.3605% |
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.970183× |
| Mean terminal wealth | 0.970185× |
| p05 terminal | 0.947893× |
| p25 terminal | 0.961748× |
| p75 terminal | 0.978988× |
| p95 terminal | 0.992086× |
| P(loss) = P(terminal < 1) | 98.80% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 3.3861% |
| p95 path max DD | 5.4105% |

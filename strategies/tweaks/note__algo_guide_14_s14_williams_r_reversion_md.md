# Tweak record: `note__algo_guide_14_s14_williams_r_reversion_md`

**Title:** s14_williams_r_reversion.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\algo_guide_14\s14_williams_r_reversion.md`  
**Adapter profile:** `guide_s14_willr_mr`  
...
Guide strategy from Strategies-to-replicate HTML. Profile `guide_s14_willr_mr` under lab shell.
...
| Metric | Value |
|--------|------:|
| Win rate (accuracy) % | 71.6921 |
| Total trades (sum set×mode) | 560 |
| Total return % (avg set×mode) | -0.2563 |
| Max drawdown % (avg) | 0.6041 |
| Profit factor (avg) | 1.0083 |
| Sharpe (avg) | -1.2839 |
| Aggregate score | 100.4266 |
| Runs (set×mode) | 8 |

**Delta win rate:** +20.2433 pp vs baseline.
...
**MC rank (by bootstrap median terminal):** **38** / 139  
...
| Historical terminal (compound order of book) | 0.979544× |
| Historical max DD | 2.8134% |
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.979436× |
| Mean terminal wealth | 0.979405× |
| p05 terminal | 0.953324× |
| p25 terminal | 0.969080× |
| p75 terminal | 0.989626× |
| p95 terminal | 1.004413× |
| P(loss) = P(terminal < 1) | 90.20% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 2.7952% |
| p95 path max DD | 5.0587% |

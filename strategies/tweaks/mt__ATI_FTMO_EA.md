# Tweak record: `mt__ATI_FTMO_EA`

**Title:** ATI_FTMO_EA  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: ATI_FTMO_EA (.mq5)`  
...
**Family id:** `mt__ATI_FTMO_EA`  
**MC rank (by bootstrap median terminal):** **136** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.926433× |
| Mean terminal wealth | 0.926413× |
| p05 terminal | 0.892749× |
| p25 terminal | 0.912128× |
| p75 terminal | 0.940825× |
| p95 terminal | 0.960203× |
| P(loss) = P(terminal < 1) | 100.00% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 7.8837% |
| p95 path max DD | 11.2017% |

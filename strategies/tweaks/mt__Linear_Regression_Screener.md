# Tweak record: `mt__Linear_Regression_Screener`

**Title:** Linear_Regression_Screener  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: Linear_Regression_Screener (.mq5)`  
...
**MC rank (by bootstrap median terminal):** **34** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.981366× |
| Mean terminal wealth | 0.981223× |
| p05 terminal | 0.963568× |
| p25 terminal | 0.974183× |
| p75 terminal | 0.988460× |
| p95 terminal | 0.998274× |
| P(loss) = P(terminal < 1) | 96.40% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 2.2839% |
| p95 path max DD | 3.9131% |

# Tweak record: `mt__FTMO_CCI_MTF_BB_EA_PART3`

**Title:** FTMO_CCI_MTF_BB_EA_PART3  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: FTMO_CCI_MTF_BB_EA_PART3 (.mq5)`  
...
**MC rank (by bootstrap median terminal):** **18** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 1.003395× |
| Mean terminal wealth | 1.003020× |
| p05 terminal | 0.986088× |
| p25 terminal | 0.995991× |
| p75 terminal | 1.009983× |
| p95 terminal | 1.019292× |
| P(loss) = P(terminal < 1) | 37.70% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 0.9425% |
| p95 path max DD | 1.9202% |

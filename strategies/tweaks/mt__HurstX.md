# Tweak record: `mt__HurstX`

**Title:** HurstX  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: HurstX (.mq5)`  
...
**Family id:** `mt__HurstX`  
**MC rank (by bootstrap median terminal):** **54** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.967983× |
| Mean terminal wealth | 0.968306× |
| p05 terminal | 0.947238× |
| p25 terminal | 0.959747× |
| p75 terminal | 0.976980× |
| p95 terminal | 0.988853× |
| P(loss) = P(terminal < 1) | 99.60% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 3.5774% |
| p95 path max DD | 5.4570% |

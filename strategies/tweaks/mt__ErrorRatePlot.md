# Tweak record: `mt__ErrorRatePlot`

**Title:** ErrorRatePlot  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: ErrorRatePlot (.mq5)`  
...
**Family id:** `mt__ErrorRatePlot`  
**MC rank (by bootstrap median terminal):** **77** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.949755× |
| Mean terminal wealth | 0.949790× |
| p05 terminal | 0.913896× |
| p25 terminal | 0.935854× |
| p75 terminal | 0.964153× |
| p95 terminal | 0.984833× |
| P(loss) = P(terminal < 1) | 98.60% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 5.8219% |
| p95 path max DD | 9.1013% |

# Tweak record: `mt__Swarm` (CCI upgraded)
...
**Family id:** `mt__Swarm`  
**MC rank (by bootstrap median terminal):** **9** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 1.008305× |
| Mean terminal wealth | 1.008178× |
| p05 terminal | 1.004593× |
| p25 terminal | 1.006899× |
| p75 terminal | 1.009551× |
| p95 terminal | 1.010880× |

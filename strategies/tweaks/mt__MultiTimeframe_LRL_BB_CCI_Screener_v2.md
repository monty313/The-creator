# Tweak record: `mt__MultiTimeframe_LRL_BB_CCI_Screener_v2`

**Title:** MultiTimeframe_LRL_BB_CCI_Screener_v2  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: MultiTimeframe_LRL_BB_CCI_Screener_v2 (.mq5)`  
...
**Family id:** `mt__MultiTimeframe_LRL_BB_CCI_Screener_v2`  
**MC rank (by bootstrap median terminal):** **85** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.941380× |
| Mean terminal wealth | 0.940682× |
| p05 terminal | 0.902802× |
| p25 terminal | 0.925082× |
| p75 terminal | 0.955308× |
| p95 terminal | 0.976422× |
| P(loss) = P(terminal < 1) | 99.10% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.6341% |
| p95 path max DD | 10.1055% |

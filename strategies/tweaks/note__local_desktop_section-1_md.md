# Tweak record: `note__local_desktop_section-1_md`

**Title:** section-1.md  
**Kind:** note  
**Source language:** `C:\Users\user\OneDrive\Desktop\The Creator\strategies\local_desktop\section-1.md`  
...
**Family id:** `note__local_desktop_section-1_md`  
**MC rank (by bootstrap median terminal):** **89** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.941244× |
| Mean terminal wealth | 0.941089× |
| p05 terminal | 0.905478× |
| p25 terminal | 0.924601× |
| p75 terminal | 0.955741× |
| p95 terminal | 0.979991× |
| P(loss) = P(terminal < 1) | 99.60% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.5906% |

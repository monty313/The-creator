# Tweak record: `mt__JordanMomentumScreener_v4_MT5`

**Title:** JordanMomentumScreener_v4_MT5  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: JordanMomentumScreener_v4_MT5 (.mq5)`  
...
**Family id:** `mt__JordanMomentumScreener_v4_MT5`  
**MC rank (by bootstrap median terminal):** **67** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.963641× |
| Mean terminal wealth | 0.963340× |
| p05 terminal | 0.935974× |
| p25 terminal | 0.950786× |
| p75 terminal | 0.975504× |
| p95 terminal | 0.990868× |
| P(loss) = P(terminal < 1) | 98.80% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 4.3069% |
| p95 path max DD | 6.8211% |

# Tweak record: `mt__kmeans`

**Title:** kmeans  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: kmeans (.mq5)`  
...
**MC rank (by bootstrap median terminal):** **48** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.969301× |
| Mean terminal wealth | 0.969178× |
| p05 terminal | 0.935737× |
| p25 terminal | 0.956416× |
| p75 terminal | 0.981983× |
| p95 terminal | 1.001831× |
| P(loss) = P(terminal < 1) | 93.40% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 4.0595% |
| p95 path max DD | 6.9070% |

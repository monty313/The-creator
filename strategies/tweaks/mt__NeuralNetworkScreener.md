# Tweak record: `mt__NeuralNetworkScreener`

**Title:** NeuralNetworkScreener  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: NeuralNetworkScreener (.mq5)`  
...
**Family id:** `mt__NeuralNetworkScreener`  
**MC rank (by bootstrap median terminal):** **100** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.940775× |
| Mean terminal wealth | 0.941136× |
| p05 terminal | 0.902272× |
| p25 terminal | 0.925622× |
| p75 terminal | 0.957238× |
| p95 terminal | 0.978123× |
| P(loss) = P(terminal < 1) | 99.70% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 6.6756% |
| p95 path max DD | 10.3349% |

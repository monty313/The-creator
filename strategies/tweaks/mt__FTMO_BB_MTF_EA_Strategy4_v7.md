# Tweak record: `mt__FTMO_BB_MTF_EA_Strategy4_v7`

**Title:** FTMO_BB_MTF_EA_Strategy4_v7  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: FTMO_BB_MTF_EA_Strategy4_v7 (.mq5)`  
...
**Family id:** `mt__FTMO_BB_MTF_EA_Strategy4_v7`  
**MC rank (by bootstrap median terminal):** **21** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 1.002816× |
| Mean terminal wealth | 1.002681× |
| p05 terminal | 0.986084× |
| p25 terminal | 0.996146× |
| p75 terminal | 1.009337× |
| p95 terminal | 1.018281× |
| P(loss) = P(terminal < 1) | 39.20% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 0.9897% |
| p95 path max DD | 1.9046% |

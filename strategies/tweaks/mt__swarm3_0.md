# Tweak record: `mt__swarm3_0` (CCI upgraded)
...
**Family id:** `mt__swarm3_0`  
**MC rank (by bootstrap median terminal):** **11** / 139  
...
| Mean terminal wealth | 1.008234× |
| p05 terminal | 1.005319× |
| p25 terminal | 1.007032× |
| p75 terminal | 1.009539× |
| p95 terminal | 1.010855× |

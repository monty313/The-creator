# Tweak record: `mt__play_4_3`

**Title:** play 4.3  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: play 4.3 (.mq5)`  
...
**Family id:** `mt__play_4_3`  
**MC rank (by bootstrap median terminal):** **61** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 0.964553× |
| Mean terminal wealth | 0.963786× |
| p05 terminal | 0.935055× |
| p25 terminal | 0.952222× |
| p75 terminal | 0.975342× |
| p95 terminal | 0.992169× |
| P(loss) = P(terminal < 1) | 97.60% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 4.2244% |
| p95 path max DD | 7.0187% |

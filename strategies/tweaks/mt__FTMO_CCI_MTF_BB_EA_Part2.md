# Tweak record: `mt__FTMO_CCI_MTF_BB_EA_Part2`

**Title:** FTMO_CCI_MTF_BB_EA_Part2  
**Kind:** mt  
**Source language:** `strategies/language/01_METATRADER_INDEX.md :: FTMO_CCI_MTF_BB_EA_Part2 (.mq5)`  
...
**Family id:** `mt__FTMO_CCI_MTF_BB_EA_Part2`  
**MC rank (by bootstrap median terminal):** **19** / 139  
...
| Metric | Value |
|--------|------:|
| Median terminal wealth | 1.003324× |
| Mean terminal wealth | 1.003244× |
| p05 terminal | 0.986743× |
| p25 terminal | 0.996539× |
| p75 terminal | 1.010000× |
| p95 terminal | 1.019550× |
| P(loss) = P(terminal < 1) | 37.20% |
| P(max DD ≥ 20%) | 0.00% |
| Median path max DD | 0.9308% |
| p95 path max DD | 1.8830% |

...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__RegressionlineEA.md`](../tweaks/mt__RegressionlineEA.md)
...
| Hist max DD | 6.3471% |
| MC median terminal | 0.940980× |
| MC mean terminal | 0.941231× |
| MC p05 / p95 | 0.904382× / 0.978265× |
| P(loss) | 99.60% |
| P(DD ≥ 20%) | 0.00% |

...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__Slope_Screener.md`](../tweaks/mt__Slope_Screener.md)
...
| Hist max DD | 5.2312% |
| MC median terminal | 0.948546× |
| MC mean terminal | 0.949728× |
| MC p05 / p95 | 0.915599× / 0.985431× |
| P(loss) | 98.80% |
| P(DD ≥ 20%) | 0.00% |

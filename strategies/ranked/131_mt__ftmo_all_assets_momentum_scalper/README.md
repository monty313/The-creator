# Rank 131: `mt__ftmo_all_assets_momentum_scalper`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__ftmo_all_assets_momentum_scalper.md`](../tweaks/mt__ftmo_all_assets_momentum_scalper.md)
...
| Hist max DD | 3.5107% |
| MC median terminal | 0.967331× |
| MC mean terminal | 0.967144× |
| MC p05 / p95 | 0.947295× / 0.986549× |
| P(loss) | 99.90% |
| P(DD ≥ 20%) | 0.00% |

...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__play_4_2.md`](../tweaks/mt__play_4_2.md)
...
| Hist max DD | 4.1046% |
| MC median terminal | 0.962710× |
| MC mean terminal | 0.962411× |
| MC p05 / p95 | 0.934028× / 0.991917× |
| P(loss) | 98.30% |
| P(DD ≥ 20%) | 0.00% |

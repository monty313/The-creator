# Rank 50: `mt__NN_CCI_Screener_Simple`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__NN_CCI_Screener_Simple.md`](../tweaks/mt__NN_CCI_Screener_Simple.md)
...
| Hist max DD | 6.3471% |
| MC median terminal | 0.939519× |
| MC mean terminal | 0.939820× |
| MC p05 / p95 | 0.901203× / 0.979701× |
| P(loss) | 99.50% |
| P(DD ≥ 20%) | 0.00% |

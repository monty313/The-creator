# Rank 4: `mt__cci_gravity_scalp_ftmo_v6_perplexity`
...
**Family id:** `mt__cci_gravity_scalp_ftmo_v6_perplexity`  
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__cci_gravity_scalp_ftmo_v6_perplexity.md`](../tweaks/mt__cci_gravity_scalp_ftmo_v6_perplexity.md)
...
| Hist max DD | 0.1055% |
| MC median terminal | 1.008386× |
| MC mean terminal | 1.008288× |
| MC p05 / p95 | 1.005018× / 1.010900× |
| P(loss) | 0.00% |
| P(DD ≥ 20%) | 0.00% |

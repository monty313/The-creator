...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__agent_teacher.md`](../tweaks/mt__agent_teacher.md)
...
| Hist max DD | 6.3471% |
| MC median terminal | 0.940224× |
| MC mean terminal | 0.940272× |
| MC p05 / p95 | 0.904583× / 0.979532× |
| P(loss) | 99.00% |
| P(DD ≥ 20%) | 0.00% |

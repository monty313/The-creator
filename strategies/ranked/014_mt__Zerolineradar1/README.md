...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__Zerolineradar1.md`](../tweaks/mt__Zerolineradar1.md)
...
| Hist max DD | 0.1055% |
| MC median terminal | 1.008204× |
| MC mean terminal | 1.008126× |
| MC p05 / p95 | 1.005121× / 1.010805× |
| P(loss) | 0.00% |
| P(DD ≥ 20%) | 0.00% |

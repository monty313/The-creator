# Rank 23: `mt__JordanMomentumScreener_v10`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__JordanMomentumScreener_v10.md`](../tweaks/mt__JordanMomentumScreener_v10.md)
...
| Hist max DD | 4.1046% |
| MC median terminal | 0.963167× |
| MC mean terminal | 0.963499× |
| MC p05 / p95 | 0.935272× / 0.993344× |
| P(loss) | 97.10% |
| P(DD ≥ 20%) | 0.00% |

...
**Family id:** `mt__Pure_CCI_Screener`  
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__Pure_CCI_Screener.md`](../tweaks/mt__Pure_CCI_Screener.md)
...
| Hist max DD | 0.1055% |
| MC median terminal | 1.008327× |
| MC mean terminal | 1.008187× |
| MC p05 / p95 | 1.004453× / 1.010914× |
| P(loss) | 0.00% |
| P(DD ≥ 20%) | 0.00% |

...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__NN_CCI_Screener.md`](../tweaks/mt__NN_CCI_Screener.md)
...
| Hist max DD | 6.3471% |
| MC median terminal | 0.939797× |
| MC mean terminal | 0.940636× |
| MC p05 / p95 | 0.905244× / 0.979716× |
| P(loss) | 99.50% |
| P(DD ≥ 20%) | 0.00% |

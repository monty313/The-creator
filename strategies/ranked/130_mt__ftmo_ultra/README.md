...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__ftmo_ultra.md`](../tweaks/mt__ftmo_ultra.md)
...
| Hist max DD | 3.5107% |
| MC median terminal | 0.967132× |
| MC mean terminal | 0.967582× |
| MC p05 / p95 | 0.947373× / 0.987922× |
| P(loss) | 99.40% |
| P(DD ≥ 20%) | 0.00% |

# Rank 54: `mt__PDF_MultiStrategy_MTF_EA_v2`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__PDF_MultiStrategy_MTF_EA_v2.md`](../tweaks/mt__PDF_MultiStrategy_MTF_EA_v2.md)
...
| Hist max DD | 6.3471% |
| MC median terminal | 0.940851× |
| MC mean terminal | 0.941044× |
| MC p05 / p95 | 0.903264× / 0.980632× |
| P(loss) | 99.50% |
| P(DD ≥ 20%) | 0.00% |

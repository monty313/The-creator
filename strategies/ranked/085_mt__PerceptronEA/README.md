...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__PerceptronEA.md`](../tweaks/mt__PerceptronEA.md)
...
| Hist max DD | 4.0540% |
| MC median terminal | 0.969085× |
| MC mean terminal | 0.968852× |
| MC p05 / p95 | 0.937252× / 1.002519× |
| P(loss) | 93.10% |
| P(DD ≥ 20%) | 0.00% |

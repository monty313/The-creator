# Rank 43: `mt__MultiTimeframe_LRL_BB_CCI_Screener_v2`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__MultiTimeframe_LRL_BB_CCI_Screener_v2.md`](../tweaks/mt__MultiTimeframe_LRL_BB_CCI_Screener_v2.md)
...
| Hist max DD | 6.3471% |
| MC median terminal | 0.941380× |
| MC mean terminal | 0.940682× |
| MC p05 / p95 | 0.902802× / 0.976422× |
| P(loss) | 99.10% |
| P(DD ≥ 20%) | 0.00% |

# Rank 45: `mt__MultiTimeframe_NN_EA_v2`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__MultiTimeframe_NN_EA_v2.md`](../tweaks/mt__MultiTimeframe_NN_EA_v2.md)
...
| Hist max DD | 6.3471% |
| MC median terminal | 0.941505× |
| MC mean terminal | 0.941858× |
| MC p05 / p95 | 0.905707× / 0.979842× |
| P(loss) | 99.50% |
| P(DD ≥ 20%) | 0.00% |

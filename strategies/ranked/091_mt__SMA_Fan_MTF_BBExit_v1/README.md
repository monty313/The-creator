# Rank 91: `mt__SMA_Fan_MTF_BBExit_v1`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__SMA_Fan_MTF_BBExit_v1.md`](../tweaks/mt__SMA_Fan_MTF_BBExit_v1.md)
...
| Hist max DD | 0.9388% |
| MC median terminal | 1.010139× |
| MC mean terminal | 1.010046× |
| MC p05 / p95 | 0.991228× / 1.027604× |
| P(loss) | 19.00% |
| P(DD ≥ 20%) | 0.00% |

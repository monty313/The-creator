...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__play_4_3.md`](../tweaks/mt__play_4_3.md)
...
| Hist max DD | 4.1046% |
| MC median terminal | 0.964553× |
| MC mean terminal | 0.963786× |
| MC p05 / p95 | 0.935055× / 0.992169× |
| P(loss) | 97.60% |
| P(DD ≥ 20%) | 0.00% |

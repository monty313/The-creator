# Rank 32: `mt__Momentum_Matrix_Screener`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__Momentum_Matrix_Screener.md`](../tweaks/mt__Momentum_Matrix_Screener.md)
...
| Hist max DD | 4.1046% |
| MC median terminal | 0.962596× |
| MC mean terminal | 0.962623× |
| MC p05 / p95 | 0.933654× / 0.991850× |
| P(loss) | 98.30% |
| P(DD ≥ 20%) | 0.00% |

# Rank 106: `mt__LinearRegressionRSI_EA`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__LinearRegressionRSI_EA.md`](../tweaks/mt__LinearRegressionRSI_EA.md)
...
| Hist max DD | 2.0091% |
| MC median terminal | 0.980372× |
| MC mean terminal | 0.980119× |
| MC p05 / p95 | 0.961790× / 0.997650× |
| P(loss) | 97.50% |
| P(DD ≥ 20%) | 0.00% |

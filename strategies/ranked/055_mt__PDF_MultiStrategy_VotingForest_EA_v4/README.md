# Rank 55: `mt__PDF_MultiStrategy_VotingForest_EA_v4`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__PDF_MultiStrategy_VotingForest_EA_v4.md`](../tweaks/mt__PDF_MultiStrategy_VotingForest_EA_v4.md)
...
| Hist max DD | 6.3471% |
| MC median terminal | 0.941032× |
| MC mean terminal | 0.940410× |
| MC p05 / p95 | 0.902354× / 0.979282× |
| P(loss) | 99.60% |
| P(DD ≥ 20%) | 0.00% |

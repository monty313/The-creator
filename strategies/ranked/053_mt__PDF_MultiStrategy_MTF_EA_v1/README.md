# Rank 53: `mt__PDF_MultiStrategy_MTF_EA_v1`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__PDF_MultiStrategy_MTF_EA_v1.md`](../tweaks/mt__PDF_MultiStrategy_MTF_EA_v1.md)
...
| MC mean terminal | 0.940692× |
| MC p05 / p95 | 0.903343× / 0.977991× |
| P(loss) | 99.90% |
| P(DD ≥ 20%) | 0.00% |

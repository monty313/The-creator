...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__FtmoDecisionTree.md`](../tweaks/mt__FtmoDecisionTree.md)
...
| Hist max DD | 7.9880% |
| MC median terminal | 0.926956× |
| MC mean terminal | 0.927352× |
| MC p05 / p95 | 0.891609× / 0.963180× |
| P(loss) | 100.00% |
| P(DD ≥ 20%) | 0.00% |

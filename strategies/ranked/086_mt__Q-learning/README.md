...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__Q-learning.md`](../tweaks/mt__Q-learning.md)
...
| Hist max DD | 4.0540% |
| MC median terminal | 0.968772× |
| MC mean terminal | 0.968721× |
| MC p05 / p95 | 0.935636× / 1.001094× |
| P(loss) | 94.20% |
| P(DD ≥ 20%) | 0.00% |

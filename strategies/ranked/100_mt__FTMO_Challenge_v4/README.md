# Rank 100: `mt__FTMO_Challenge_v4`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__FTMO_Challenge_v4.md`](../tweaks/mt__FTMO_Challenge_v4.md)
...
| Hist max DD | 7.9880% |
| MC median terminal | 0.927363× |
| MC mean terminal | 0.927349× |
| MC p05 / p95 | 0.891372× / 0.961756× |
| P(loss) | 99.90% |
| P(DD ≥ 20%) | 0.00% |

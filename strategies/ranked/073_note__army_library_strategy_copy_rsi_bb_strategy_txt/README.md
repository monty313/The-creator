# Rank 73: `note__army_library_strategy_copy_rsi_bb_strategy_txt`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/note__army_library_strategy_copy_rsi_bb_strategy_txt.md`](../tweaks/note__army_library_strategy_copy_rsi_bb_strategy_txt.md)
...
| Hist max DD | 6.3471% |
| MC median terminal | 0.940966× |
| MC mean terminal | 0.941973× |
| MC p05 / p95 | 0.904716× / 0.982017× |
| P(loss) | 99.20% |
| P(DD ≥ 20%) | 0.00% |

...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__FTMO_Challenge_EA.md`](../tweaks/mt__FTMO_Challenge_EA.md)
...
| Hist max DD | 7.9880% |
| MC median terminal | 0.926795× |
| MC mean terminal | 0.927105× |
| MC p05 / p95 | 0.895289× / 0.961207× |
| P(loss) | 99.80% |
| P(DD ≥ 20%) | 0.00% |

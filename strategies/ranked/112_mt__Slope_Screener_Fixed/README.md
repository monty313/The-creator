# Rank 112: `mt__Slope_Screener_Fixed`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__Slope_Screener_Fixed.md`](../tweaks/mt__Slope_Screener_Fixed.md)
...
| Hist max DD | 5.2312% |
| MC median terminal | 0.949688× |
| MC mean terminal | 0.949837× |
| MC p05 / p95 | 0.914748× / 0.986050× |
| P(loss) | 99.00% |
| P(DD ≥ 20%) | 0.00% |

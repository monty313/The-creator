# Rank 71: `note__army_library_strategy_copy_new_trading_strategies_1_md`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/note__army_library_strategy_copy_new_trading_strategies_1_md.md`](../tweaks/note__army_library_strategy_copy_new_trading_strategies_1_md.md)
...
| Hist max DD | 6.3471% |
| MC median terminal | 0.939362× |
| MC mean terminal | 0.940465× |
| MC p05 / p95 | 0.902903× / 0.980467× |
| P(loss) | 99.10% |
| P(DD ≥ 20%) | 0.00% |

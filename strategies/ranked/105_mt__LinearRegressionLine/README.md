# Rank 105: `mt__LinearRegressionLine`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__LinearRegressionLine.md`](../tweaks/mt__LinearRegressionLine.md)
...
| Hist max DD | 2.0091% |
| MC median terminal | 0.980654× |
| MC mean terminal | 0.980780× |
| MC p05 / p95 | 0.962603× / 0.998180× |
| P(loss) | 97.40% |
| P(DD ≥ 20%) | 0.00% |

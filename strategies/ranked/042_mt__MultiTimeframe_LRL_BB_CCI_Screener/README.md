# Rank 42: `mt__MultiTimeframe_LRL_BB_CCI_Screener`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__MultiTimeframe_LRL_BB_CCI_Screener.md`](../tweaks/mt__MultiTimeframe_LRL_BB_CCI_Screener.md)
...
| Hist max DD | 6.3471% |
| MC median terminal | 0.940113× |
| MC mean terminal | 0.939909× |
| MC p05 / p95 | 0.903739× / 0.977994× |
| P(loss) | 99.20% |
| P(DD ≥ 20%) | 0.00% |

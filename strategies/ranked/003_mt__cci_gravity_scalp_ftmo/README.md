# Rank 3: `mt__cci_gravity_scalp_ftmo`
...
**Family id:** `mt__cci_gravity_scalp_ftmo`  
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__cci_gravity_scalp_ftmo.md`](../tweaks/mt__cci_gravity_scalp_ftmo.md)
...
| Hist max DD | 0.1055% |
| MC median terminal | 1.008251× |
| MC mean terminal | 1.008145× |
| MC p05 / p95 | 1.005184× / 1.010916× |
| P(loss) | 0.00% |
| P(DD ≥ 20%) | 0.00% |

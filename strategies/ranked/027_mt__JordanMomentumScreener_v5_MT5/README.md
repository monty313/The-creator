# Rank 27: `mt__JordanMomentumScreener_v5_MT5`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__JordanMomentumScreener_v5_MT5.md`](../tweaks/mt__JordanMomentumScreener_v5_MT5.md)
...
| Hist max DD | 4.1046% |
| MC median terminal | 0.963457× |
| MC mean terminal | 0.962928× |
| MC p05 / p95 | 0.933879× / 0.992246× |
| P(loss) | 98.60% |
| P(DD ≥ 20%) | 0.00% |

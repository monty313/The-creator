# Rank 72: `note__army_library_strategy_copy_new_trading_strategies_md`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/note__army_library_strategy_copy_new_trading_strategies_md.md`](../tweaks/note__army_library_strategy_copy_new_trading_strategies_md.md)
...
| Hist max DD | 6.3471% |
| MC median terminal | 0.941306× |
| MC mean terminal | 0.940453× |
| MC p05 / p95 | 0.902408× / 0.977104× |
| P(loss) | 99.40% |
| P(DD ≥ 20%) | 0.00% |

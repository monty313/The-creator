# Rank 81: `note__mark_doctrine_refs_RSI_BB_L2L_SKILL_md`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/note__mark_doctrine_refs_RSI_BB_L2L_SKILL_md.md`](../tweaks/note__mark_doctrine_refs_RSI_BB_L2L_SKILL_md.md)
...
| Hist max DD | 6.3471% |
| MC median terminal | 0.941336× |
| MC mean terminal | 0.941020× |
| MC p05 / p95 | 0.903839× / 0.979253× |
| P(loss) | 99.60% |
| P(DD ≥ 20%) | 0.00% |

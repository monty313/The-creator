...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__ATI_FTMO_EA.md`](../tweaks/mt__ATI_FTMO_EA.md)
...
| Hist max DD | 7.9880% |
| MC median terminal | 0.926433× |
| MC mean terminal | 0.926413× |
| MC p05 / p95 | 0.892749× / 0.960203× |
| P(loss) | 100.00% |
| P(DD ≥ 20%) | 0.00% |

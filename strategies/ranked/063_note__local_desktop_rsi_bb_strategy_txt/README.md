# Rank 63: `note__local_desktop_rsi_bb_strategy_txt`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/note__local_desktop_rsi_bb_strategy_txt.md`](../tweaks/note__local_desktop_rsi_bb_strategy_txt.md)
...
| Hist max DD | 6.3471% |
| MC median terminal | 0.939677× |
| MC mean terminal | 0.940330× |
| MC p05 / p95 | 0.903601× / 0.981024× |
| P(loss) | 99.60% |
| P(DD ≥ 20%) | 0.00% |

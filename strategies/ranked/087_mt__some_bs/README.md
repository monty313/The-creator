...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__some_bs.md`](../tweaks/mt__some_bs.md)
...
| Hist max DD | 4.0540% |
| MC median terminal | 0.969352× |
| MC mean terminal | 0.968964× |
| MC p05 / p95 | 0.936675× / 0.999934× |
| P(loss) | 95.00% |
| P(DD ≥ 20%) | 0.00% |

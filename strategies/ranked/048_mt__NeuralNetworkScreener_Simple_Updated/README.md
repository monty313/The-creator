# Rank 48: `mt__NeuralNetworkScreener_Simple_Updated`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__NeuralNetworkScreener_Simple_Updated.md`](../tweaks/mt__NeuralNetworkScreener_Simple_Updated.md)
...
| Hist max DD | 6.3471% |
| MC median terminal | 0.940094× |
| MC mean terminal | 0.940503× |
| MC p05 / p95 | 0.905013× / 0.978875× |
| P(loss) | 99.30% |
| P(DD ≥ 20%) | 0.00% |

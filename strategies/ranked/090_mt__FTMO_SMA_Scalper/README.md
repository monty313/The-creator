...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__FTMO_SMA_Scalper.md`](../tweaks/mt__FTMO_SMA_Scalper.md)
...
| Hist max DD | 0.9388% |
| MC median terminal | 1.009612× |
| MC mean terminal | 1.009925× |
| MC p05 / p95 | 0.992459× / 1.027438× |
| P(loss) | 17.70% |
| P(DD ≥ 20%) | 0.00% |

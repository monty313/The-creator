# Rank 47: `mt__NeuralNetworkScreener_Simple`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__NeuralNetworkScreener_Simple.md`](../tweaks/mt__NeuralNetworkScreener_Simple.md)
...
| Hist max DD | 6.3471% |
| MC median terminal | 0.939992× |
| MC mean terminal | 0.940297× |
| MC p05 / p95 | 0.901161× / 0.976084× |
| P(loss) | 98.80% |
| P(DD ≥ 20%) | 0.00% |

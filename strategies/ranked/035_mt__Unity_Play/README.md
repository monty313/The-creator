...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__Unity_Play.md`](../tweaks/mt__Unity_Play.md)
...
| Hist max DD | 4.1046% |
| MC median terminal | 0.962464× |
| MC mean terminal | 0.962551× |
| MC p05 / p95 | 0.933903× / 0.991358× |
| P(loss) | 98.40% |
| P(DD ≥ 20%) | 0.00% |

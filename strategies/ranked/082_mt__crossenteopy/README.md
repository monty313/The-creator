...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__crossenteopy.md`](../tweaks/mt__crossenteopy.md)
...
| Hist max DD | 4.0540% |
| MC median terminal | 0.969626× |
| MC mean terminal | 0.969608× |
| MC p05 / p95 | 0.935308× / 1.002706× |
| P(loss) | 93.70% |
| P(DD ≥ 20%) | 0.00% |

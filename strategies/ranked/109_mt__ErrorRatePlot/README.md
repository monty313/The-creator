...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__ErrorRatePlot.md`](../tweaks/mt__ErrorRatePlot.md)
...
| Hist max DD | 5.2312% |
| MC median terminal | 0.949755× |
| MC mean terminal | 0.949790× |
| MC p05 / p95 | 0.913896× / 0.984833× |
| P(loss) | 98.60% |
| P(DD ≥ 20%) | 0.00% |

# Rank 46: `mt__NeuralNetworkScreener`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__NeuralNetworkScreener.md`](../tweaks/mt__NeuralNetworkScreener.md)
...
| Hist max DD | 6.3471% |
| MC median terminal | 0.940775× |
| MC mean terminal | 0.941136× |
| MC p05 / p95 | 0.902272× / 0.978123× |
| P(loss) | 99.70% |
| P(DD ≥ 20%) | 0.00% |

# Rank 61: `note__local_desktop_new_trading_strategies_1_md`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/note__local_desktop_new_trading_strategies_1_md.md`](../tweaks/note__local_desktop_new_trading_strategies_1_md.md)
...
| Hist max DD | 6.3471% |
| MC median terminal | 0.939000× |
| MC mean terminal | 0.940045× |
| MC p05 / p95 | 0.899933× / 0.981253× |
| P(loss) | 99.70% |
| P(DD ≥ 20%) | 0.00% |

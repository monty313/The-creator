# Rank 70: `note__local_desktop_section-8_md`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/note__local_desktop_section-8_md.md`](../tweaks/note__local_desktop_section-8_md.md)
...
| Hist max DD | 6.3471% |
| MC median terminal | 0.940877× |
| MC mean terminal | 0.940122× |
| MC p05 / p95 | 0.900013× / 0.977839× |
| P(loss) | 99.70% |
| P(DD ≥ 20%) | 0.00% |

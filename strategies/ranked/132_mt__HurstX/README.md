...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__HurstX.md`](../tweaks/mt__HurstX.md)
...
| Hist max DD | 3.5107% |
| MC median terminal | 0.967983× |
| MC mean terminal | 0.968306× |
| MC p05 / p95 | 0.947238× / 0.988853× |
| P(loss) | 99.60% |
| P(DD ≥ 20%) | 0.00% |

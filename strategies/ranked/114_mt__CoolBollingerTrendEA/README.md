# Rank 114: `mt__CoolBollingerTrendEA`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__CoolBollingerTrendEA.md`](../tweaks/mt__CoolBollingerTrendEA.md)
...
| Hist max DD | 6.5566% |
| MC median terminal | 0.935756× |
| MC mean terminal | 0.935821× |
| MC p05 / p95 | 0.905792× / 0.967500× |
| P(loss) | 100.00% |
| P(DD ≥ 20%) | 0.00% |

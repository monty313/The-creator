...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__S11_Runner.md`](../tweaks/mt__S11_Runner.md)
...
| Hist max DD | 7.9880% |
| MC median terminal | 0.926773× |
| MC mean terminal | 0.926894× |
| MC p05 / p95 | 0.890557× / 0.962761× |
| P(loss) | 100.00% |
| P(DD ≥ 20%) | 0.00% |

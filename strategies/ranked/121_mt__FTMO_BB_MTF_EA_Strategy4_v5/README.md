# Rank 121: `mt__FTMO_BB_MTF_EA_Strategy4_v5`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__FTMO_BB_MTF_EA_Strategy4_v5.md`](../tweaks/mt__FTMO_BB_MTF_EA_Strategy4_v5.md)
...
| Hist max DD | 1.3071% |
| MC median terminal | 1.003169× |
| MC mean terminal | 1.003154× |
| MC p05 / p95 | 0.986500× / 1.020147× |
| P(loss) | 36.30% |
| P(DD ≥ 20%) | 0.00% |

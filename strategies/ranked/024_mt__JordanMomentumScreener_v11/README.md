# Rank 24: `mt__JordanMomentumScreener_v11`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__JordanMomentumScreener_v11.md`](../tweaks/mt__JordanMomentumScreener_v11.md)
...
| Hist max DD | 4.1046% |
| MC median terminal | 0.964270× |
| MC mean terminal | 0.964224× |
| MC p05 / p95 | 0.934419× / 0.994195× |
| P(loss) | 97.60% |
| P(DD ≥ 20%) | 0.00% |

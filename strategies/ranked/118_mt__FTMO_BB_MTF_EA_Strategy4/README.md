# Rank 118: `mt__FTMO_BB_MTF_EA_Strategy4`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__FTMO_BB_MTF_EA_Strategy4.md`](../tweaks/mt__FTMO_BB_MTF_EA_Strategy4.md)
...
| Hist max DD | 1.3071% |
| MC median terminal | 1.002074× |
| MC mean terminal | 1.002263× |
| MC p05 / p95 | 0.986776× / 1.018755× |
| P(loss) | 41.50% |
| P(DD ≥ 20%) | 0.00% |

# Rank 57: `mt__RL_PropTrader_Final`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__RL_PropTrader_Final.md`](../tweaks/mt__RL_PropTrader_Final.md)
...
| Hist max DD | 6.3471% |
| MC median terminal | 0.941070× |
| MC mean terminal | 0.941064× |
| MC p05 / p95 | 0.902333× / 0.979077× |
| P(loss) | 99.50% |
| P(DD ≥ 20%) | 0.00% |

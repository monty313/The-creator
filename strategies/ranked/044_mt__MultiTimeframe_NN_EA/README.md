# Rank 44: `mt__MultiTimeframe_NN_EA`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__MultiTimeframe_NN_EA.md`](../tweaks/mt__MultiTimeframe_NN_EA.md)
...
| Hist max DD | 6.3471% |
| MC median terminal | 0.939994× |
| MC mean terminal | 0.940083× |
| MC p05 / p95 | 0.903744× / 0.977022× |
| P(loss) | 99.40% |
| P(DD ≥ 20%) | 0.00% |

# Rank 52: `mt__OnlineLearnerEA_v5_Fixed`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__OnlineLearnerEA_v5_Fixed.md`](../tweaks/mt__OnlineLearnerEA_v5_Fixed.md)
...
| Hist max DD | 6.3471% |
| MC median terminal | 0.940691× |
| MC mean terminal | 0.940389× |
| MC p05 / p95 | 0.901785× / 0.978794× |
| P(loss) | 99.10% |
| P(DD ≥ 20%) | 0.00% |

...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__FTMO_DQN.md`](../tweaks/mt__FTMO_DQN.md)
...
| Hist max DD | 6.3471% |
| MC median terminal | 0.940768× |
| MC mean terminal | 0.941000× |
| MC p05 / p95 | 0.905554× / 0.977407× |
| P(loss) | 99.30% |
| P(DD ≥ 20%) | 0.00% |

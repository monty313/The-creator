# Rank 123: `mt__FTMO_BB_MTF_EA_Strategy4_v7`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__FTMO_BB_MTF_EA_Strategy4_v7.md`](../tweaks/mt__FTMO_BB_MTF_EA_Strategy4_v7.md)
...
| Hist max DD | 1.3071% |
| MC median terminal | 1.002816× |
| MC mean terminal | 1.002681× |
| MC p05 / p95 | 0.986084× / 1.018281× |
| P(loss) | 39.20% |
| P(DD ≥ 20%) | 0.00% |

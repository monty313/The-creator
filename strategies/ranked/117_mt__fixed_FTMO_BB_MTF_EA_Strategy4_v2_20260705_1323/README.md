# Rank 117: `mt__fixed_FTMO_BB_MTF_EA_Strategy4_v2_20260705_1323`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__fixed_FTMO_BB_MTF_EA_Strategy4_v2_20260705_1323.md`](../tweaks/mt__fixed_FTMO_BB_MTF_EA_Strategy4_v2_20260705_1323.md)
...
| Hist max DD | 1.3071% |
| MC median terminal | 1.002557× |
| MC mean terminal | 1.002554× |
| MC p05 / p95 | 0.987643× / 1.019048× |
| P(loss) | 40.10% |
| P(DD ≥ 20%) | 0.00% |

...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__Simple_scalper.md`](../tweaks/mt__Simple_scalper.md)
...
| Hist max DD | 3.5107% |
| MC median terminal | 0.967646× |
| MC mean terminal | 0.967286× |
| MC p05 / p95 | 0.946416× / 0.987529× |
| P(loss) | 99.70% |
| P(DD ≥ 20%) | 0.00% |

# Rank 124: `mt__FTMO_CCI_MTF_BB_EA_Part2`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__FTMO_CCI_MTF_BB_EA_Part2.md`](../tweaks/mt__FTMO_CCI_MTF_BB_EA_Part2.md)
...
| Hist max DD | 1.3071% |
| MC median terminal | 1.003324× |
| MC mean terminal | 1.003244× |
| MC p05 / p95 | 0.986743× / 1.019550× |
| P(loss) | 37.20% |
| P(DD ≥ 20%) | 0.00% |

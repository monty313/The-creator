...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__swarm3_0.md`](../tweaks/mt__swarm3_0.md)
...
| MC mean terminal | 1.008234× |
| MC p05 / p95 | 1.005319× / 1.010855× |
| P(loss) | 0.00% |
| P(DD ≥ 20%) | 0.00% |

# Rank 122: `mt__FTMO_BB_MTF_EA_Strategy4_v6`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__FTMO_BB_MTF_EA_Strategy4_v6.md`](../tweaks/mt__FTMO_BB_MTF_EA_Strategy4_v6.md)
...
| Hist max DD | 1.3071% |
| MC median terminal | 1.002791× |
| MC mean terminal | 1.003047× |
| MC p05 / p95 | 0.987112× / 1.020034× |
| P(loss) | 36.80% |
| P(DD ≥ 20%) | 0.00% |

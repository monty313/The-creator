# Rank 29: `mt__JordanMomentumScreener_v8_HUD`
...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__JordanMomentumScreener_v8_HUD.md`](../tweaks/mt__JordanMomentumScreener_v8_HUD.md)
...
| Hist max DD | 4.1046% |
| MC median terminal | 0.964203× |
| MC mean terminal | 0.963760× |
| MC p05 / p95 | 0.933970× / 0.992642× |
| P(loss) | 98.00% |
| P(DD ≥ 20%) | 0.00% |

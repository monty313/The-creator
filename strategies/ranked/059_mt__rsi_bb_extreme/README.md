...
Window: 2026-06-10 03:48:00 → 2026-07-17 22:27:00 (40000 M1)  
Source: [`TWEAKED_ACCURACY_REPORT.md`](../TWEAKED_ACCURACY_REPORT.md) · tweak file: [`../tweaks/mt__rsi_bb_extreme.md`](../tweaks/mt__rsi_bb_extreme.md)
...
| Hist max DD | 6.3471% |
| MC median terminal | 0.941046× |
| MC mean terminal | 0.941173× |
| MC p05 / p95 | 0.903898× / 0.979284× |
| P(loss) | 99.80% |
| P(DD ≥ 20%) | 0.00% |
